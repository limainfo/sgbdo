			...
			<div class="block_head">
				<div class="bheadl"></div>
					<div class="bheadr"></div>
						<h2>Avaliações Finais Autorizadas -> Total: <cfoutput>#url.total#</cfoutput> Página: <cfoutput>#url.pagina#/#paginas#</cfoutput></h2>  
						...
						<table cellpadding="0" cellspacing="0" width="100%" class="sortable">
							...
							<cfif isquery(conteudoconsulta) >
								...
								<cfset i=i+1>
									...
									<td>#funcao#</td>
									<td>#usuario#</td>
									<td>#dateformat(prazo, 'dd-mm-yyyy')#</td>
									<td class="acoes"><a href="javascript:exclui('#evaluate('##' & controllernomeid & '##')#', '#nome#-#cpf#-#habilitacao#');" title="Excluir"><img src="images/lixo.png" alt="Excluir"></a></td>
