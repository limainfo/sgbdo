...
<div class="hdrr"></div>
				...
				<cfif ListGetAt(menu,1) eq 1 >
					<li><a href="#"><img src="images/menu_gerente01.png">&nbsp;Gerente</a>
						<ul>
							...
							<li><a href="?d=<cfoutput>#appID#</cfoutput>&i=Estagiário&acao=list"><img src="images/menu_gerente04.png">&nbsp;Estagiários</a></li>
							<li><a href="?d=<cfoutput>#appID#</cfoutput>&i=Estagiário&acao=conferência"><img src="images/menu_gerente05.png">&nbsp;Conferência</a></li>
							<li><a href="?d=<cfoutput>#appID#</cfoutput>&i=Habilitação&acao=list"><img src="images/menu_gerente05.png">&nbsp;Habilitações</a></li>
							<li><a href="?d=<cfoutput>#appID#</cfoutput>&i=Cgna&acao=list"><img src="images/menu_gerente06.png">&nbsp;Proposta CGNA</a></li>
							<!--<li><a href="?d=<cfoutput>#appID#</cfoutput>&i=Estagiário&acao=list"><img src="images/menu_gerente06.png">&nbsp;Gerar item SIGPES</a></li> -->
						</ul>
					</li>
				</cfif>
				<cfif ListGetAt(menu,2) eq 1 >
					<li><a href="#"><img src="images/menu_instrucao01.png">&nbsp;Seção de Instrução</a>
						<ul>
							<li><a href="?d=<cfoutput>#appID#</cfoutput>&i=Estagiário&acao=list"><img src="images/menu_instrucao03.png">&nbsp;Listar Estagiários</a></li>
							<li><a href="?d=<cfoutput>#appID#</cfoutput>&i=Instrutorestagiario&acao=list"><img src="images/menu_instrucao04.png">&nbsp;Avaliação final</a></li>
							<li><a href="?d=<cfoutput>#appID#</cfoutput>&i=Ficha&acao=list&tipo=instrução"><img src="images/menu_instrucao05.png">&nbsp;Assinar Fichas</a></li>
				...
				<cfif ListGetAt(menu,3) eq 1 >
					<li><a href="#"><img src="images/menu_instrutor01.png">&nbsp;Instrutor</a>
						<ul>
							<li><a href="?d=<cfoutput>#appID#</cfoutput>&i=Ficha&acao=list"><img src="images/menu_instrutor02.png">&nbsp;Avaliar Estagiários</a></li>
						</ul>
					</li>
				</cfif>
				<cfif ListGetAt(menu,4) eq 1 >
					<li><a href="#"><img src="images/menu_relatorio01.png">&nbsp;Relatórios</a>
						<ul>
							<li><a href="#"><img src="images/menu_relatorio02.png">&nbsp;Processo</a>
								<ul>
									...
									<li><a href="index.cfm?d=<cfoutput>#appID#</cfoutput>&i=pdf&nome=fichasnaoassinadas&pesquisa=<cfoutput>#urlencode(url.pesquisa)#</cfoutput>"><img src="images/menu_relatorio02.png">&nbsp;Fichas não assinadas</a></li>
								</ul>
							</li>
							<li><a href="#"><img src="images/menu_relatorio02.png">&nbsp;BIRD</a>
								<ul>
								<li><a href="../../../?i=Relatórios&d=<cfoutput>#appID#</cfoutput>&nome=bird&view=472361d0-84be-11e2-9e96-0800200c9a77"><img src="images/menu_relatorio02.png">&nbsp;Relatórios</a></li>
								</ul>
							</li>


							<!--
							<li><a href="#"><img src="images/menu_relatorio02.png">&nbsp;Habilitação</a>
								<ul>
									...
									<li><a href="index.cfm?d=<cfoutput>#appID#</cfoutput>&i=pdf&nome=habilitacaoorgao&pesquisa=<cfoutput>#urlencode(url.pesquisa)#</cfoutput>"><img src="images/menu_relatorio02.png">&nbsp;Por órgão</a></li>
				...
				<cfif ListGetAt(menu,5) eq 1 >
					<li><a href="#"><img src="images/menu_parametro01.png">&nbsp;Parâmetros</a>
						<ul>
							...
							<li><a href="?d=<cfoutput>#appID#</cfoutput>&i=Usuário&acao=list"><img src="images/menu_parametro05.png">&nbsp;Usuários</a></li>
