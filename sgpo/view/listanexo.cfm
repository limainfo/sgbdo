						...
						<table cellpadding="0" cellspacing="0" width="100%" class="sortable">
							...
							<cfif isquery(conteudoconsulta) >
								...
								<cfset i=i+1>
									...
									<td class="acoes"><a href="javascript:exclui('#evaluate('##' & controllernomeid & '##')#', '#documento#-#anexo#-#item#-#sequenciaitem#');" title="Excluir"><img src="images/lixo.png" alt="Excluir"></a></td>
