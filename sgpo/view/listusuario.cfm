						...
						<table cellpadding="0" cellspacing="0" width="100%" class="sortable">
							...
							<cfif isquery(conteudoconsulta) >
								...
								<cfset i=i+1>
									...
									<td>#perfilID#</td>
									<td>#perfil#</td>
									<td class="acoes"><a href="javascript:edita('#evaluate('##' & controllernomeid & '##')#');" title="Modificar"><img src="images/edit.png" alt="Gerar"></a></td>
									<td class="acoes"><a href="javascript:exclui('#evaluate('##' & controllernomeid & '##')#', '#usuario#-#cpf#');" title="Excluir"><img src="images/lixo.png" alt="Excluir"></a></td>
								</tr>									
									</cfoutput>
								</cfif>
							</tbody>
