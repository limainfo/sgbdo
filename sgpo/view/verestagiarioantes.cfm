...
<body>
	...
	<h3>CURSOS (CÓDIGO / NOME / LOCAL / DATA)</h3>
	<div>
		<p>
		<span >##cursocodigo##/##cursonome##/##cursolocal##/##cursodata##</span>
		</p>
		<ul>
			<li>List item one</li>
			<li>List item two</li>
	...
	<h3>EXPERIÊNCIA FUNCIONAL (FUNÇÃO / ÓRGÃO / PERÍODO)</h3>
	<div>
		<p>
		<span >##funcao## / ##orgao## / ##periodo##</span>
		<span >PARECER:</span><span >##jesparecer##</span>
		<span >VALIDADE:</span><span >##jesvalidade##</span>
		</p>
	</div>
	<h3>EXAME DE SAÚDE </h3>
	<div>
		<p>
		<span >JES/DATA:</span><span >##jesdata##</span>
		 </p>
	</div>
	</div>
</body>
