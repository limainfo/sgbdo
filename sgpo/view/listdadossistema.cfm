						...
						<table cellpadding="0" cellspacing="0" width="100%" class="sortable">
							...
							<cfif isquery(conteudoconsulta) >
								...
								<cfset i=i+1>
									...
									<td>#identidade#</td>
									<td>#matricula#</td>
									<td>#dateformat(dtmovimentacao, 'dd-mm-yyyy')#</td>
									<td>#dateformat(dtdesligamento, 'dd-mm-yyyy')#</td>
									<td>#dateformat(dtapresentacao, 'dd-mm-yyyy')#</td>
									<td>#sistema#</td>
									<td class="acoes"><a href="javascript:designa('#evaluate('##' & controllernomeid & '##')#');" title="Designar estágio"><img src="images/designa.png" alt="Editar"></a></td>
