<cfheader name="Content-Disposition" value="inline; filename=estagiarioaguardaata.pdf">
...
<tr>
	<th colspan="12" align="center" class="bordamaior">#titulo#</th>
</tr>
  <tr>
    <td scope="col" class="bordamaior"><div align="center" class="txthead">PROC.</div></td>
    ...
    <td scope="col" class="bordamaior"><div align="center" class="txthead">C.TEÓRICA</div></td>
    <td scope="col" class="bordamaior"><div align="center" class="txthead">C.PRÁTICA</div></td>
    <td scope="col" class="bordamaior"><div align="center" class="txthead">H.PREVISTAS</div></td>
    <td scope="col" class="bordamaior"><div align="center" class="txthead">H.CONCLUÍDAS</div></td>
  </tr>
	<cfset i=1>
<cfloop query="conteudoconsulta">
	...
	<cfset i=i+1>
    <td scope="col" class="borda"><div align="center" class="txtin">#numeroprocesso#</div></td>
	<td scope="col" class="borda"><div align="center" class="txtin">#unidade#</div></td>
    ...
    <td scope="col" class="borda"><div align="center" class="txtin">#cargateorica#</div></td>
    <td scope="col" class="borda"><div align="center" class="txtin">#cargapratica#</div></td>
