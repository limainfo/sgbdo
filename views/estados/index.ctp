...
<div class="estados index">
	...
	<table cellpadding="0" cellspacing="0">
                    <tr><td colspan="5">
	<h1><?php __('Estados');?>    &nbsp;<?php echo $this->Html->link($this->Html->image('novo.gif', array('alt'=> __('Cadastrar', true), 'border'=> '0', 'title'=>'Cadastrar')), array('action'=>'add', null),array('escape'=>false, 'escape'=>false), null,false); ?>	</h1>
...
?><?php echo $form->end(); ?>
	...
	<tr<?php echo $class;?>>
		...
		<td><?php echo $estado['Estado']['uf']; ?>&nbsp;</td>
		<td>
			<?php echo $this->Html->link($estado['Paise']['nome'], array('controller' => 'paises', 'action' => 'view', $estado['Paise']['id'])); ?>
		</td>
		<td class="actions">

		<?php echo $this->Html->link($this->Html->image('lupa.gif', array('alt'=> __('Exibir', true), 'border'=> '0', 'title'=>'Visualizar')), array('action'=>'view', $estado['Estado']['id']),array('escape'=>false, 'escape'=>false), null,false); ?>

		<?php echo $this->Html->link($this->Html->image('lapis.gif', array('alt'=> __('Editar', true), 'border'=> '0', 'title'=>'Editar')), array('action'=>'edit', $estado['Estado']['id']),array('escape'=>false, 'escape'=>false), null,false); ?>
