...
<div class="paises index">
	...
	<table cellpadding="0" cellspacing="0">
                    <tr><td colspan="5">
	<h1><?php __('Países');?>    &nbsp;<?php echo $this->Html->link($this->Html->image('novo.gif', array('alt'=> __('Cadastrar', true), 'border'=> '0', 'title'=>'Cadastrar')), array('action'=>'add', null),array('escape'=>false, 'escape'=>false), null,false); ?>	</h1>
...
?><?php echo $form->end(); ?>
	...
	<tr<?php echo $class;?>>
		...
		<td><?php echo $paise['Paise']['sigla']; ?>&nbsp;</td>
		<td><?php echo $paise['Paise']['idioma']; ?>&nbsp;</td>
		<td><?php echo $paise['Paise']['nome']; ?>&nbsp;</td>
		<td class="actions">

		<?php echo $this->Html->link($this->Html->image('lupa.gif', array('alt'=> __('Exibir', true), 'border'=> '0', 'title'=>'Visualizar')), array('action'=>'view', $paise['Paise']['id']),array('escape'=>false, 'escape'=>false), null,false); ?>

		<?php echo $this->Html->link($this->Html->image('lapis.gif', array('alt'=> __('Editar', true), 'border'=> '0', 'title'=>'Editar')), array('action'=>'edit', $paise['Paise']['id']),array('escape'=>false, 'escape'=>false), null,false); ?>
