...
function EscondeDica(){
	...
	?>
	<tr <?php echo $class;?>>
		<td onmouseover='ExibeDica("<b><u>Responsável pelo cadastro</u></b><br><b>Responsável:</b><?php echo $responsavel[0][$afastamento['Afastamento']['militar_responsavel']];?><br><b>Identidade:</b><?php echo $responsavel[1][$afastamento['Afastamento']['militar_responsavel']];?><br><b>Dt Registro:</b><?php echo date('d-m-Y h:i:s',strtotime($afastamento['Afastamento']['created']));?><br><br>");' onmouseout="EscondeDica();">
...
<!-- <div  rel='tooltip' id='i<?php echo $afastamento['Afastamento']['id']; ?>' title='<?php echo '<p style="background-color:#000;color:#fff;"><br><b>Responsável:</b>'.$responsavel[0][$afastamento['Afastamento']['militar_responsavel']]."<br><b>Identidade:</b>".$responsavel[1][$afastamento['Afastamento']['militar_responsavel']].'<br><b>Dt Registro:</b>'.date('d-m-Y',strtotime($afastamento['Afastamento']['created'])).'<br><br></p>'; ?>'>
			<?php echo $this->Html->link($afastamento['Militar']['Posto']['sigla_posto'].' '.$afastamento['Militar']['Especialidade']['nm_especialidade'].' '.$afastamento['Militar']['nm_completo'], array('controller'=> 'militars', 'action'=>'view', $afastamento['Militar']['id']),array('rel'=>'tooltip')); ?>
			</div>
 -->		
		</td>
