...
<div class="rotulos index">
<h1><?php __('Rotulos');?><?php
$script = "var x=\$('find').value;if(x.blank()){\$('broffice').href='".$this->webroot."Rotulos/indexExcel/';}else{\$('broffice').href='".$this->webroot."Rotulos/indexExcel/'+x;}";?>
...
<tr>
	...
	<th><?php echo $paginator->sort('rotulo');?></th>
...
?>
	<tr<?php echo $class;?>>
		<td>
			<?php echo $rotulo['Rotulo']['id']; ?>
		</td>
		<td>
			<?php echo $rotulo['Rotulo']['rotulo']; ?>
		</td>
		<td class="actions">
			<?php echo $this->Html->link($this->Html->image('lupa.gif', array('alt'=> __('Exibir', true), 'border'=> '0', 'title'=>'Visualizar')), array('action'=>'view', $rotulo['Rotulo']['id']),array('escape'=>false, 'escape'=>false), null,false); ?>			<?php echo $this->Html->link($this->Html->image('lapis.gif', array('alt'=> __('Editar', true), 'border'=> '0', 'title'=>'Editar')), array('action'=>'edit', $rotulo['Rotulo']['id']),array('escape'=>false, 'escape'=>false), null,false); ?>			<?php  echo $this->Html->link($this->Html->image('lixo.gif', array('alt'=> __('Excluir', true), 'border'=> '0', 'title'=>'Excluir')), array(), array('onmousedown'=>"dialogo('Deseja realmente excluir o registro #".$rotulo['Rotulo']['id']." ?' ,'".$this->webroot.$this->params['controller'].'/delete/'.$rotulo['Rotulo']['id']."');",'onclick'=>"this.href='#';return false;",'escape'=>false, 'escape'=>false), null,false);?>		</td>
	</tr>
<?php endforeach; ?>
</table>
</div>
