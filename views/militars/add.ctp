...
<?php echo $form->create('Militar');?>
	<fieldset>
 		<legend><?php __('Cadastrar Militar');?>&nbsp;&nbsp;&nbsp;<?php echo $this->Html->link($this->Html->image('setaesq.gif', array('alt'=> __('Índice', true), 'border'=> '0', 'title'=>'Índice')), array('action'=>'index', null),array('escape'=>false, 'escape'=>false), null,false); ?>
 		</legend>
		<?php echo $form->input('setor_id',array('class'=>'formulario','options'=>$unidades, 'default'=>0));  ?>
...
<?php
		...
		//echo $form->input('endereco',array('class'=>'formulario'));
		//echo $form->input('bairro',array('class'=>'formulario'));
		echo $form->input('email',array('class'=>'formulario'));
		//echo $form->input('subdivisao',array('class'=>'formulario'));
		echo $form->input('sexo',array('class'=>'formulario', 'type'=>'select', 'options'=>$sexos, 'default'=>''));
		...
		//echo $form->input('orgao',array('class'=>'formulario'));
		...
		//echo $form->input('cindade_nascimento',array('class'=>'formulario'));
		...
		echo $form->input('ativa',array('class'=>'formulario', 'type'=>'select', 'options'=>array('1'=>'ATIVADO','0'=>'DESATIVADO'), 'default'=>'1'));
		?>
	</fieldset>
