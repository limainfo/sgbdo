...
for($i=2011;$i<=(date('Y')+2);$i++){
	...
	echo $form->input('militar_id',array('class'=>'formulario','onChange'=>'atribui();')); 
	echo $form->input('divisao',array('class'=>'formulario','value'=>'OPERACIONAL','readonly'=>'readonly')); 
	echo $form->hidden('nome_militar',array('class'=>'formulario')); 
	echo $form->input('nome_chamada',array('class'=>'formulario','value'=>'EXPEDIENTE')); 
