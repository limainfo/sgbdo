...
<div class="cargosconselhos index">
	<h1><?php __('Cargosconselhos');?>    &nbsp;<?php echo $this->Html->link($this->Html->image('novo.gif', array('alt'=> __('Cadastrar', true), 'border'=> '0', 'title'=>'Cadastrar')), array('action'=>'add', null),array('escape'=>false, 'escape'=>false), null,false); ?>	</h1>
...
<?php echo $form->end(); ?>
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('nm_cargo');?></th>
			<th><?php echo $this->Paginator->sort('descricao');?></th>
			<th class="actions"><?php __('Ações');?></th>
	</tr>
	<?php
	$i = 0;
	foreach ($cargosconselhos as $cargosconselho):
		$class = null;
		if ($i++ % 2 == 0) {
			$class = ' class="altrow"';
		}
	?>
	<tr<?php echo $class;?>>
		<td><?php echo $cargosconselho['Cargosconselho']['id']; ?>&nbsp;</td>
		<td><?php echo $cargosconselho['Cargosconselho']['nm_cargo']; ?>&nbsp;</td>
		<td><?php echo $cargosconselho['Cargosconselho']['descricao']; ?>&nbsp;</td>
		<td class="actions">

		<?php echo $this->Html->link($this->Html->image('lupa.gif', array('alt'=> __('Exibir', true), 'border'=> '0', 'title'=>'Visualizar')), array('action'=>'view', $cargosconselho['Cargosconselho']['id']),array('escape'=>false, 'escape'=>false), null,false); ?>

		<?php echo $this->Html->link($this->Html->image('lapis.gif', array('alt'=> __('Editar', true), 'border'=> '0', 'title'=>'Editar')), array('action'=>'edit', $cargosconselho['Cargosconselho']['id']),array('escape'=>false, 'escape'=>false), null,false); ?>
