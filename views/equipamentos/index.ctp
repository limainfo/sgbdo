...
<h1><?php __('Equipamentos');?><?php
$script = "var x=\$('find').value;if(x.blank()){\$('broffice').href='".$this->webroot."Equipamentos/indexExcel/';}else{\$('broffice').href='".$this->webroot."Equipamentos/indexExcel/'+x;}";?>
...
<tr>
	...
	<th><?php echo $paginator->sort('localidade_id');?></th>
...
?>
	<tr<?php echo $class;?>>
		...
		<td>
			<?php echo $equipamento['Equipamento']['tipo']; ?>
		</td>
		<td>
			<?php echo $equipamento['Equipamento']['descricao']; ?>
		</td>
		<td>
			<?php echo $equipamento['Equipamento']['localidade_id']; ?>
		</td>
		<td class="actions">
			<?php echo $this->Html->link($this->Html->image('lupa.gif', array('alt'=> __('Exibir', true), 'border'=> '0', 'title'=>'Visualizar')), array('action'=>'view', $equipamento['Equipamento']['id']),array('escape'=>false, 'escape'=>false), null,false); ?>			<?php echo $this->Html->link($this->Html->image('lapis.gif', array('alt'=> __('Editar', true), 'border'=> '0', 'title'=>'Editar')), array('action'=>'edit', $equipamento['Equipamento']['id']),array('escape'=>false, 'escape'=>false), null,false); ?>			<?php  echo $this->Html->link($this->Html->image('lixo.gif', array('alt'=> __('Excluir', true), 'border'=> '0', 'title'=>'Excluir')), array(), array('onmousedown'=>"dialogo('Deseja realmente excluir o registro #".$equipamento['Equipamento']['id']." ?' ,'".$this->webroot.$this->params['controller'].'/delete/'.$equipamento['Equipamento']['id']."');",'onclick'=>"this.href='#';return false;",'escape'=>false, 'escape'=>false), null,false);?>		</td>
	</tr>
<?php endforeach; ?>
</table>
</div>
