...
<div class="empresas index">
	<h1><?php __('Empresas');?>    &nbsp;<?php echo $this->Html->link($this->Html->image('novo.gif', array('alt'=> __('Cadastrar', true), 'border'=> '0', 'title'=>'Cadastrar')), array('action'=>'add', null),array('escape'=>false, 'escape'=>false), null,false); ?>	</h1>
...
<?php echo $form->end(); ?>
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('nm_empresa');?></th>
			<th><?php echo $this->Paginator->sort('sigla_empresa');?></th>
	...
	<tr<?php echo $class;?>>
		...
		<td><?php echo $empresa['Empresa']['nm_empresa']; ?>&nbsp;</td>
		<td><?php echo $empresa['Empresa']['sigla_empresa']; ?>&nbsp;</td>
		<td class="actions">

		<?php echo $this->Html->link($this->Html->image('lupa.gif', array('alt'=> __('Exibir', true), 'border'=> '0', 'title'=>'Visualizar')), array('action'=>'view', $empresa['Empresa']['id']),array('escape'=>false, 'escape'=>false), null,false); ?>

		<?php echo $this->Html->link($this->Html->image('lapis.gif', array('alt'=> __('Editar', true), 'border'=> '0', 'title'=>'Editar')), array('action'=>'edit', $empresa['Empresa']['id']),array('escape'=>false, 'escape'=>false), null,false); ?>
