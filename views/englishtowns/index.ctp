...
<div class="englishtowns index">
	<h1><?php __('Englishtowns');?>	&nbsp;<?php echo $this->Html->link($this->Html->image('broffice.png', array('alt'=> __('BROffice', true), 'border'=> '0', 'title'=>'Dados em planilha BROffice', 'onmouseover'=>"\$('busca').action='".$this->webroot."englishtowns/indexExcel/';", 'onclick'=>'$("busca").submit();' )), '#', array('id'=>'broffice','escape'=>false), null,false); ?>	
	...
	<?php echo $form->create('formFind', array('url' => 'index','type'=>'file','action' => 'index','controller' => 'englishtowns','id'=>'busca','onsubmit'=>'sql();')); ?>	
	<h3>
	<?php
...
<?php
		...
		echo '</select>&nbsp;&nbsp;&nbsp;<img border="0" onclick="ShowContent(\'filtro\');"  title="Filtrar Dados" alt="Filtro" src="'.$this->webroot.'img/filtro.gif"  onmouseover="$(\'busca\').action=\''.$this->webroot.'englishtowns/index/\';"/></div>'; ?>
...
?>
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('posto');?></th>
			<th><?php echo $this->Paginator->sort('especialidade');?></th>
			<th><?php echo $this->Paginator->sort('nome_completo');?></th>
			<th><?php echo $this->Paginator->sort('nome_guerra');?></th>
			<th><?php echo $this->Paginator->sort('orgao');?></th>
			<th><?php echo $this->Paginator->sort('Local');?></th>
			<th><?php echo $this->Paginator->sort('email');?></th>
			<th><?php echo $this->Paginator->sort('nivel_atual');?></th>
			<th><?php echo $this->Paginator->sort('meta_icao');?></th>
			<th><?php echo $this->Paginator->sort('atividades');?></th>
			<th><?php echo $this->Paginator->sort('unidades');?></th>
			<th><?php echo $this->Paginator->sort('horas');?></th>
			<th><?php echo $this->Paginator->sort('evolucao');?></th>
			<th><?php echo $this->Paginator->sort('meta_npa');?></th>
			<th><?php echo $this->Paginator->sort('observacoes_tutoria');?></th>
	...
	?>
	<tr<?php echo $class;?>>
		<td><?php echo $englishtown['Englishtown']['mes']; ?>&nbsp;</td>
		<td><?php echo $englishtown['Englishtown']['ano']; ?>&nbsp;</td>
		<td><?php echo $englishtown['Englishtown']['posto']; ?>&nbsp;</td>
		<td><?php echo $englishtown['Englishtown']['especialidade']; ?>&nbsp;</td>
		<td><?php echo $englishtown['Englishtown']['nome_completo']; ?>&nbsp;</td>
		<td><?php echo $englishtown['Englishtown']['nome_guerra']; ?>&nbsp;</td>
		<td><?php echo $englishtown['Englishtown']['orgao']; ?>&nbsp;</td>
		<td><?php echo $englishtown['Englishtown']['Local']; ?>&nbsp;</td>
		<td><?php echo $englishtown['Englishtown']['email']; ?>&nbsp;</td>
		<td><?php echo $englishtown['Englishtown']['nivel_atual']; ?>&nbsp;</td>
		<td><?php echo $englishtown['Englishtown']['meta_icao']; ?>&nbsp;</td>
		<td><?php echo $englishtown['Englishtown']['atividades']; ?>&nbsp;</td>
		<td><?php echo $englishtown['Englishtown']['unidades']; ?>&nbsp;</td>
		<td><?php echo $englishtown['Englishtown']['horas']; ?>&nbsp;</td>
		<td><?php echo $englishtown['Englishtown']['evolucao']; ?>&nbsp;</td>
		<td><?php echo $englishtown['Englishtown']['meta_npa']; ?>&nbsp;</td>
		<td><?php echo $englishtown['Englishtown']['observacoes_tutoria']; ?>&nbsp;</td>
		<td><?php echo $englishtown['Englishtown']['id']; ?>&nbsp;</td>
		<td>
			<?php echo $this->Html->link($englishtown['Militar']['nm_completo'], array('controller' => 'militars', 'action' => 'view', $englishtown['Militar']['id'])); ?>
		</td>
		<td class="actions">

		<?php echo $this->Html->link($this->Html->image('lupa.gif', array('alt'=> __('Exibir', true), 'border'=> '0', 'title'=>'Visualizar')), array('action'=>'view', $englishtown['Englishtown']['id']),array('escape'=>false, 'escape'=>false), null,false); ?>

		<?php echo $this->Html->link($this->Html->image('lapis.gif', array('alt'=> __('Editar', true), 'border'=> '0', 'title'=>'Editar')), array('action'=>'edit', $englishtown['Englishtown']['id']),array('escape'=>false, 'escape'=>false), null,false); ?>
