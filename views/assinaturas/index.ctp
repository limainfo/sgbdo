...
<table cellpadding="0" cellspacing="0">
	...
	<tr <?php echo $class;?>>
		...
		<td><?php echo $foto['Assinatura']['type']; ?></td>
		<td><?php echo $foto['Assinatura']['name']; ?></td>
		<td><?php echo $foto['Assinatura']['size']; ?></td>
		<td><?php echo $this->Html->image(array('controller'=> 'assinaturas', 'action'=>'download', $foto['Assinatura']['id']), array('alt'=> __('Assinatura', true), 'border'=> '0', 'width'=>'40', 'height'=>'30' )); ?>
		</td>
		<td><?php echo $foto['Assinatura']['created']; ?></td>
		<td><?php echo $foto['Assinatura']['updated']; ?></td>
		...
		<?php
		 echo $this->Html->link($this->Html->image('lixo.gif', array('alt'=> __('Excluir', true), 'border'=> '0', 'title'=>'Excluir')), array(), array('onmousedown'=>"dialogo('Deseja realmente excluir o registro #".$foto['Militar']['Posto']['sigla_posto'].' '.$foto['Militar']['Especialidade']['nm_especialidade'].' '.$foto['Militar']['nm_completo']." ?' ,'".$this->webroot.$this->params['controller'].'/delete/'.$foto['Assinatura']['id']."');",'onclick'=>"this.href='#';return false;",'escape'=>false, 'escape'=>false), null,false); 
		?>
		</td>
	</tr>
	<?php endforeach; ?>
