...
<div class="qualificacaos index">
	<h1><?php __('Qualificacaos');?>    &nbsp;<?php echo $this->Html->link($this->Html->image('novo.gif', array('alt'=> __('Cadastrar', true), 'border'=> '0', 'title'=>'Cadastrar')), array('action'=>'add', null),array('escape'=>false, 'escape'=>false), null,false); ?>	</h1>
...
<?php echo $form->end(); ?>
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('nm_qualificacao');?></th>
			<th><?php echo $this->Paginator->sort('sigla_qualificacao');?></th>
	...
	?>
	<tr<?php echo $class;?>>
		<td><?php echo $qualificacao['Qualificacao']['id']; ?>&nbsp;</td>
		<td><?php echo $qualificacao['Qualificacao']['nm_qualificacao']; ?>&nbsp;</td>
		<td><?php echo $qualificacao['Qualificacao']['sigla_qualificacao']; ?>&nbsp;</td>
		<td class="actions">

		<?php echo $this->Html->link($this->Html->image('lupa.gif', array('alt'=> __('Exibir', true), 'border'=> '0', 'title'=>'Visualizar')), array('action'=>'view', $qualificacao['Qualificacao']['id']),array('escape'=>false, 'escape'=>false), null,false); ?>

		<?php echo $this->Html->link($this->Html->image('lapis.gif', array('alt'=> __('Editar', true), 'border'=> '0', 'title'=>'Editar')), array('action'=>'edit', $qualificacao['Qualificacao']['id']),array('escape'=>false, 'escape'=>false), null,false); ?>
