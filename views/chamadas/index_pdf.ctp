...
$html .= '<tr bgcolor="#cccccc" align="center" ><td width="46%" rowspan="2">NOME DE GUERRA</td><td width="3%" colspan="2">INI</td><td width="24%" rowspan="2">JUSTIFICATIVA INÍCIO</td><td width="3%" colspan="2">TER</td><td width="24%" rowspan="2">JUSTIFICATIVA TÉRMINO</td></tr>';
...
foreach ($militar as $dados){
	...
	$tmpp = '<td>'.$dados['Posto']['sigla_posto'].' '.$dados['Quadro']['sigla_quadro'].' '.$dados['Especialidade']['nm_especialidade'].'</td>';
        $tmp = '[<b>'.$dados['Posto']['sigla_posto'].' '.$dados['Quadro']['sigla_quadro'].' '.$dados['Especialidade']['nm_especialidade'].' '.$dados['Chamada']['nome_guerra'].'</b>]';
