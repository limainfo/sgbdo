...
<form accept-charset="utf-8" action="/sgbdo/chamadas/add" method="post"
	enctype="multipart/form-data" id="ChamadaConsulta">
		Chamada<input type="text"
			id="ChamadaNomeChamada" maxlength="150"
			class="formulario"
			name="nome_chamada">
		&nbsp;&nbsp;&nbsp;Dia<input type="text" id="ChamadaDia"
			class="formulario" readonly="readonly" name="dia"  value="<?php echo $dia; ?>"><a
			onclick="return showCalendar('ChamadaDia', '%Y-%m-%d', '24', true); return false;"
			href="#"><img alt="" src="/sgbdo/img/../js/jscalendar/img.gif"></a>
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="submit" value="Consultar" url="">
</form>
<?php 	
