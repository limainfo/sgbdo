...
<div class="exames index">
	<h1><?php __('Exames');?>	&nbsp;<?php echo $this->Html->link($this->Html->image('broffice.png', array('alt'=> __('BROffice', true), 'border'=> '0', 'title'=>'Dados em planilha BROffice', 'onmouseover'=>"\$('busca').action='".$this->webroot."exames/indexExcel/';", 'onclick'=>'$("busca").submit();' )), '#', array('id'=>'broffice','escape'=>false), null,false); ?>	
	...
	<?php echo $form->create('formFind', array('url' => 'index','type'=>'file','action' => 'index','controller' => 'exames','id'=>'busca','onsubmit'=>'sql();')); ?>	
	<h3>
	<?php
...
<?php
		...
		echo '</select>&nbsp;&nbsp;&nbsp;<img border="0" onclick="ShowContent(\'filtro\');"  title="Filtrar Dados" alt="Filtro" src="'.$this->webroot.'img/filtro.gif"  onmouseover="$(\'busca\').action=\''.$this->webroot.'exames/index/\';"/></div>'; ?>
...
?>
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('data_exame');?></th>
	...
	?>
	<tr<?php echo $class;?>>
		<td><?php echo $exame['Exame']['id']; ?>&nbsp;</td>
		<td>
			<?php echo $this->Html->link($exame['Militar']['nm_completo'], array('controller' => 'militars', 'action' => 'view', $exame['Militar']['id'])); ?>
		</td>
		<td><?php echo $exame['Exame']['data_exame']; ?>&nbsp;</td>
		<td><?php echo $exame['Exame']['parecer']; ?>&nbsp;</td>
		<td><?php echo $exame['Exame']['data_validade']; ?>&nbsp;</td>
		<td class="actions">

		<?php echo $this->Html->link($this->Html->image('lupa.gif', array('alt'=> __('Exibir', true), 'border'=> '0', 'title'=>'Visualizar')), array('action'=>'view', $exame['Exame']['id']),array('escape'=>false, 'escape'=>false), null,false); ?>

		<?php echo $this->Html->link($this->Html->image('lapis.gif', array('alt'=> __('Editar', true), 'border'=> '0', 'title'=>'Editar')), array('action'=>'edit', $exame['Exame']['id']),array('escape'=>false, 'escape'=>false), null,false); ?>
