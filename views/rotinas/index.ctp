...
<div class="rotinas index">
	<h1><?php __('Rotinas');?>	&nbsp;<?php echo $this->Html->link($this->Html->image('broffice.png', array('alt'=> __('BROffice', true), 'border'=> '0', 'title'=>'Dados em planilha BROffice', 'onmouseover'=>"\$('busca').action='".$this->webroot."rotinas/indexExcel/';", 'onclick'=>'$("busca").submit();' )), '#', array('id'=>'broffice','escape'=>false), null,false); ?>	
	...
	<?php echo $form->create('formFind', array('url' => 'index','type'=>'file','action' => 'index','controller' => 'rotinas','id'=>'busca','onsubmit'=>'sql();')); ?>	
	<h3>
	<?php
...
<?php
		...
		echo '</select>&nbsp;&nbsp;&nbsp;<img border="0" onclick="ShowContent(\'filtro\');"  title="Filtrar Dados" alt="Filtro" src="'.$this->webroot.'img/filtro.gif"  onmouseover="$(\'busca\').action=\''.$this->webroot.'rotinas/index/\';"/></div>'; ?>
...
?>
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('doc_referencia');?></th>
			<th><?php echo $this->Paginator->sort('acao');?></th>
			<th><?php echo $this->Paginator->sort('responsavel');?></th>
			<th><?php echo $this->Paginator->sort('periodicidade_id');?></th>
			<th><?php echo $this->Paginator->sort('dia_previsto');?></th>
			<th><?php echo $this->Paginator->sort('mes_previsto');?></th>
			<th><?php echo $this->Paginator->sort('rotina_id');?></th>
			<th><?php echo $this->Paginator->sort('ativa');?></th>
			<th><?php echo $this->Paginator->sort('created');?></th>
			<th><?php echo $this->Paginator->sort('dt_referencia');?></th>
	...
	?>
	<tr<?php echo $class;?>>
		<td><?php echo $rotina['Rotina']['id']; ?>&nbsp;</td>
		<td><?php echo $rotina['Rotina']['orgao_id']; ?>&nbsp;</td>
		<td>
			<?php echo $this->Html->link($rotina['Setor']['sigla_setor'], array('controller' => 'setors', 'action' => 'view', $rotina['Setor']['id'])); ?>
		</td>
		<td><?php echo $rotina['Rotina']['doc_referencia']; ?>&nbsp;</td>
		<td><?php echo $rotina['Rotina']['acao']; ?>&nbsp;</td>
		<td><?php echo $rotina['Rotina']['responsavel']; ?>&nbsp;</td>
		<td>
		...
		<td><?php echo $rotina['Rotina']['dia_previsto']; ?>&nbsp;</td>
		<td><?php echo $rotina['Rotina']['mes_previsto']; ?>&nbsp;</td>
		<td><?php echo $rotina['Rotina']['rotina_id']; ?>&nbsp;</td>
		<td><?php echo $rotina['Rotina']['ativa']; ?>&nbsp;</td>
		<td><?php echo $rotina['Rotina']['created']; ?>&nbsp;</td>
		<td><?php echo $rotina['Rotina']['dt_referencia']; ?>&nbsp;</td>
		<td class="actions">

		<?php echo $this->Html->link($this->Html->image('lupa.gif', array('alt'=> __('Exibir', true), 'border'=> '0', 'title'=>'Visualizar')), array('action'=>'view', $rotina['Rotina']['id']),array('escape'=>false, 'escape'=>false), null,false); ?>

		<?php echo $this->Html->link($this->Html->image('lapis.gif', array('alt'=> __('Editar', true), 'border'=> '0', 'title'=>'Editar')), array('action'=>'edit', $rotina['Rotina']['id']),array('escape'=>false, 'escape'=>false), null,false); ?>
