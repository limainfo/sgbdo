<div class="parecerestecnicos form"><?php echo $form->create('Parecerestecnico',array('type'=>'file'));?>
<fieldset><legend><?php __('Cadastrar Parecer técnico');?>&nbsp;&nbsp;&nbsp;
...
echo $form->input('situacao',array('type'=>'select','options'=>array($qtds),'class'=>'formulario'));
