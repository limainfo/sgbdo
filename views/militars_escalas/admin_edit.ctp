...
<?php echo $form->create('MilitarsEscala');?>
	<fieldset>
 		<legend><?php __('Edit MilitarsEscala');?></legend>
	<?php
		echo $form->input('id');
...
<div class="actions">
	<ul>
		<li><?php echo $this->Html->link(__('Excluir', true), array('action'=>'delete', $form->value('MilitarsEscala.id')), array('class'=>'button'), sprintf(__('Tem certeza que deseja excluir # %s?', true), $form->value('MilitarsEscala.id'))); ?></li>
