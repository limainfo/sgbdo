...
<?php echo $form->create('Ocorrenciastecnica');?>
	<fieldset>
 		<legend><?php __('Add Ocorrenciastecnica');?>		&nbsp;&nbsp;&nbsp;<?php echo $this->Html->link($this->Html->image('setaesq.gif', array('alt'=> __('Índice', true), 'border'=> '0', 'title'=>'Índice')), array('action'=>'index', null),array('escape'=>false, 'escape'=>false), null,false); ?> 		
 		</legend>
