...
<div class="quadros index">
	<h1><?php __('Quadros');?>	&nbsp;<?php echo $this->Html->link($this->Html->image('broffice.png', array('alt'=> __('BROffice', true), 'border'=> '0', 'title'=>'Dados em planilha BROffice', 'onmouseover'=>"\$('busca').action='".$this->webroot."quadros/indexExcel/';", 'onclick'=>'$("busca").submit();' )), '#', array('id'=>'broffice','escape'=>false), null,false); ?>	
	...
	<?php echo $form->create('formFind', array('url' => 'index','type'=>'file','action' => 'index','controller' => 'quadros','id'=>'busca','onsubmit'=>'sql();')); ?>	
	<h3>
	<?php
...
<?php
		...
		echo '</select>&nbsp;&nbsp;&nbsp;<img border="0" onclick="ShowContent(\'filtro\');"  title="Filtrar Dados" alt="Filtro" src="'.$this->webroot.'img/filtro.gif"  onmouseover="$(\'busca\').action=\''.$this->webroot.'quadros/index/\';"/></div>'; ?>
...
?>
	...
	<tr>
			<th><?php echo $this->Paginator->sort('nm_quadro');?></th>
			<th><?php echo $this->Paginator->sort('sigla_quadro');?></th>
			<th><?php echo $this->Paginator->sort('semespec');?></th>
			<th><?php echo $this->Paginator->sort('codq');?></th>
	...
	?>
	<tr<?php echo $class;?>>
		<td><?php echo $quadro['Quadro']['nm_quadro']; ?>&nbsp;</td>
		<td><?php echo $quadro['Quadro']['sigla_quadro']; ?>&nbsp;</td>
		<td><?php echo $quadro['Quadro']['semespec']; ?>&nbsp;</td>
		<td><?php echo $quadro['Quadro']['codq']; ?>&nbsp;</td>
		<td class="actions">

		<?php echo $this->Html->link($this->Html->image('lupa.gif', array('alt'=> __('Exibir', true), 'border'=> '0', 'title'=>'Visualizar')), array('action'=>'view', $quadro['Quadro']['id']),array('escape'=>false, 'escape'=>false), null,false); ?>

		<?php echo $this->Html->link($this->Html->image('lapis.gif', array('alt'=> __('Editar', true), 'border'=> '0', 'title'=>'Editar')), array('action'=>'edit', $quadro['Quadro']['id']),array('escape'=>false, 'escape'=>false), null,false); ?>
