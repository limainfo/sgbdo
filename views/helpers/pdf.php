...
class PdfHelper extends FPDF {
	...
	function Escala($escala, $preenche, $turnos, $legendas, $unidade, $dtm, $dta, $selprev, $versos, $afastamento, $consultasql,$podeexibirrascunho, $afastamentoignorado, $quadrinhos, $regras)
	{
		...
		if($normal){
			...
			//if($podeexibirrascunho==1){
				if(!empty($idescalante)){
					$this->SetFont('Arial','',5);
					$this->SetXY(25,15);
					$this->Cell(155,20,iconv('UTF-8','ISO-8859-1','ASSINATURA ELETRÔNICA Nº '.crc32($idescalante)),0,1,'R');
				...
				if(!empty($idchefe)){
					$this->SetFont('Arial','',5);
					$this->SetXY(25,23);
					$this->Cell(155,20,iconv('UTF-8','ISO-8859-1','ASSINATURA ELETRÔNICA Nº '.crc32($idchefe)),0,1,'R');
					if(file_exists($caminho.'webroot/pdf/assina'.$idchefe.'.jpg')){
						$this->Image($caminho.'webroot/pdf/assina'.$idchefe.'.jpg',140,30,40,5.7);
					}
				}
				/*
				if(!empty($idcheferegional)){
					$this->SetFont('Arial','',5);
					$this->SetXY(25,31);
					$this->Cell(155,20,iconv('UTF-8','ISO-8859-1','ASSINATURA ELETRÔNICA Nº '.$idcheferegional),0,1,'R');
					if(file_exists($caminho.'webroot/pdf/assina'.$idcheferegional.'.jpg')){
						$this->Image($caminho.'webroot/pdf/assina'.$idcheferegional.'.jpg',140,30,40,5.7);
					}
				}
				*/
				if(!empty($assinacomandante)){
					$this->SetFont('Arial','',5);
					$this->SetXY(25,31);
					$this->Cell(155,20,iconv('UTF-8','ISO-8859-1','ASSINATURA ELETRÔNICA Nº '.crc32($assinacomandante)),0,1,'R');
					if(file_exists($caminho.'webroot/pdf/assina'.$assinacomandante.'.jpg')){
						$this->Image($caminho.'webroot/pdf/assina'.$assinacomandante.'.jpg',140,30,40,5.7);
					}
				}
			...
			if($rascunho==1){
				...
				$this->SetTextColor(200,200,200);
                                if($this->w>210){
                                    $this->RotatedText(20,190,'RASCUNHO  -  AGUARDA  ASSINATURA  DO  ESCALANTE',30);
				...
				$this->SetTextColor(200,200,200);
                                if($this->w>210){
                                    $this->RotatedText(20,190,'RASCUNHO  -  AGUARDA  ASSINATURA  DO  CHEFE LOCAL',30);
				...
				$this->SetTextColor(200,200,200);
                                if($this->w>210){
                                //    $this->RotatedText(20,190,'RASCUNHO  -  AGUARDA  ASSINATURA  DO  CHEFE  REGIONAL',30);
			...
			$this->Cell(65,4,iconv('UTF-8','ISO-8859-1','ESCALA DO MÊS/ANO'),0,0,'L');
			$this->Cell(($this->w-145),4,iconv('UTF-8','ISO-8859-1','ESCALANTE'),0,0,'L');
			$this->SetFont('Arial','',8);
			$this->SetXY(20,23);
			...
			if($selprev=='p'){
				$this->Cell(65,4,iconv('UTF-8','ISO-8859-1','PREVISTA - '.$meses[$dtm].'/ '.$dta),0,0,'C');
			}else{
				$this->Cell(65,4,iconv('UTF-8','ISO-8859-1','CUMPRIDA - '.$meses[$dtm].'/ '.$dta),0,0,'C');
			}

			//$this->Cell(32,4,iconv('UTF-8','ISO-8859-1',$meses[$dtm].'/ '.$dta),0,0,'C');
                        if($this->w<=211){
                            $this->SetFont('Arial','',5);
                            $this->Cell(($this->w-145),8,iconv('UTF-8','ISO-8859-1',$escalante),0,0,'C');
                        }else{
                            $this->Cell(($this->w-145),6,iconv('UTF-8','ISO-8859-1',$escalante),0,0,'C');
                        }
			$this->SetXY(20,20);
			$this->Cell(43,8,' ',1,0,'C');
			$this->Cell(65,8,' ',1,0,'C');
			//$this->Cell(32,8,' ',1,0,'C');
			$this->Cell(($this->w-145),8,' ',1,0,'C');
			...
			if(((preg_match($p1, $t01))||(preg_match($p2, $t01))||(preg_match($p3, $t01)))&&($novoPDF<=200908)){
				$this->SetFont('Arial','B',8);
				$this->Cell(($this->w-145),8,iconv('UTF-8','ISO-8859-1','CHEFE DO ÓRGÃO'),0,0,'L');

			}else{

				if($podeexibirrascunho==1){
						
					//if(!empty($assinacomandante)){ 	$this->Image('img/assinaturacmt.jpg',150,36,18,8);					}
				}
				$this->SetFont('Arial','B',8);
				$this->Cell(($this->w-145),4,iconv('UTF-8','ISO-8859-1','CHEFE DO ÓRGÃO'),0,0,'L');
			...
			if(((preg_match($p1, $t01))||(preg_match($p2, $t01))||(preg_match($p3, $t01)))&&($novoPDF<=200908)){
				...
				$this->SetFont('Arial','',5);
				$this->SetXY(128,39);
				$this->Cell(($this->w-145),8,iconv('UTF-8','ISO-8859-1',$chefe),0,0,'C');
                               }else{
				$this->SetXY(128,39);
				$this->Cell(($this->w-145),8,iconv('UTF-8','ISO-8859-1',$chefe),0,0,'C');
                               }
				...
				$this->Cell(($this->w-145),6,iconv('UTF-8','ISO-8859-1',$chefe),0,0,'C');
                                }
			...
			if(((preg_match($p1, $t01))||(preg_match($p2, $t01))||(preg_match($p3, $t01)))&&($novoPDF<=200908)){
				...
				if($escala['Escala']['tipo']=='RISAER'){
					$this->Cell(($this->w-145),4,iconv('UTF-8','ISO-8859-1','CHEFE DA DIVISÃO ADMINISTRATIVA'),0,0,'L');
				}
				if($escala['Escala']['tipo']=='OPERACIONAL'){
					$this->Cell(($this->w-145),4,iconv('UTF-8','ISO-8859-1','CHEFE DA DIVISÃO DE OPERAÇÕES'),0,0,'L');
				}
				if($escala['Escala']['tipo']=='TECNICA'){
					$this->Cell(($this->w-145),4,iconv('UTF-8','ISO-8859-1','CHEFE DA DIVISÃO TÉCNICA'),0,0,'L');
				}
			...
			if(((preg_match($p1, $t01))||(preg_match($p2, $t01))||(preg_match($p3, $t01)))&&($novoPDF<=200908)){
                ...
                if($this->w<=211){
					$this->SetFont('Arial','',5);
					$this->Cell(($this->w-145),8,iconv('UTF-8','ISO-8859-1',$comandante),0,0,'C');
                }else{
					$this->Cell(($this->w-145),6,iconv('UTF-8','ISO-8859-1',$comandante),0,0,'C');
                }
			}
			...
			if(((preg_match($p1, $t01))||(preg_match($p2, $t01))||(preg_match($p3, $t01)))&&($novoPDF<=200908)){
				...
				$this->Cell(($this->w-145),8,iconv('UTF-8','ISO-8859-1',' '),1,0,'C');
			}
			$this->SetXY(20,44);
			$this->SetFont('Arial','B',8);
			...
			$this->SetFont('Arial','B',6);
			$xant_cabecalho = $this->GetX();
			$yant_cabecalho = $this->GetY();
				...
				foreach ($turnos as $turno){
					...
					for ($l=1;$l<=$turno['Turno']['qtd'];$l++){
						...
						if(strlen($k)<5){
							...
							if($escala24h){
                                                            if(strlen($preenche[$dia][$preenche[$dia][$contagem]][$turno['Turno']['id']]['escalado'])>0){
                                                                $escaladoleg = $preenche[$dia][$preenche[$dia][$contagem]][$turno['Turno']['id']]['escalado'].' ';
                                                            }else{
                                                                $escaladoleg = '';
                                                            }
                                                            ...
                                                            if(strlen($preenche[$dia][$preenche[$dia][$contagem]][$turno['Turno']['id']]['legenda'])>0){
			...
			$constanteTam = $this->w-$constanteTam;
			...
			foreach ($turnos as $turno){
				...
				if(strlen($turno['Turno']['rotulo'])<17){
					$this->SetFont('Arial','B',6);
			...
			$folga = $tampagina -55 - floor($tamtotal);
			...
			$tobs = 5;
                        ...
                        if(($tipo=='RISAER')||($tipo=='TECNICA')){
                            ...
                            $this->SetFont('Arial','B',8);
                            $this->Cell($folga-1,4,'FOLGA',0,0,'C');
                            $this->SetFont('Arial','B',5);
                            $this->Cell($tobs,4,'OBS',0,0,'L');
                            $this->SetFont('Arial','B',8);
                        }
			...
			for($c=1;$c<=$qtd_turnos;$c++){
				//$this->Cell($tamanhos[$turno['Turno']['id']]['tamanho'],6,' ',1,0,'C');
                        ...
                        $tmp1 = ($this->w-17)-$this->GetX();
                        $this->Cell($tmp1,6,'',1,0,'C');
			...
			$reservas = $versos[0]['Versoescala']['reservas'];
                            if($escala['Escala']['tipo']=='RISAER'){
                                $this->SetFont('Arial','B',8);
                                $this->SetXY(20,$ini);
                                ...
                                $this->SetTextColor(0,0,0);
                                $this->MultiCell($tampagina-37,5,iconv('UTF-8','ISO-8859-1','RESERVAS:'.$reservas),1,'L',1);
                                $ini = $this->GetY();
                                $this->SetXY(20,$ini);
                            }                        
			$this->SetFont('Arial','',10);
			...
			$this->SetFont('Arial','B',10);
			$this->SetXY(20,$ini);
			$this->Cell($tampagina-35,5,iconv('UTF-8','ISO-8859-1','LEGENDAS'),1,0,'C');
			$this->SetFont('Arial','',10);
			$ini+=5;
			...
			$this->SetTextColor(0,0,0);
                        ...
                        if($this->w>211){
                            $tm1 = 4.31/100*($tampagina-35);
                            $tm2 = 14.66/100*($tampagina-35);
                            $tm3 = 6.03/100*($tampagina-35);                        
                        }else{
                            $tm1 = 5.75/100*($tampagina-35);
                            $tm2 = 19.54/100*($tampagina-35);
                            $tm3 = 8.05/100*($tampagina-35);                        
                        }
			$this->Cell($tm1,4,iconv('UTF-8','ISO-8859-1','CÓD'),1,0,'C',1);
			$this->Cell($tm2,4,'OPERADOR',1,0,'C');
			$this->Cell($tm3,4,'INDICATIVO',1,0,'C');
			$this->Cell($tm1,4,iconv('UTF-8','ISO-8859-1','CÓD'),1,0,'C',1);
			$this->Cell($tm2,4,'OPERADOR',1,0,'C');
			$this->Cell($tm3,4,'INDICATIVO',1,0,'C');
			$this->Cell($tm1,4,iconv('UTF-8','ISO-8859-1','CÓD'),1,0,'C',1);
			...
			foreach ($legendas as $militar){
				...
				$this->SetXY($x,$ini);
				$this->SetFont('Arial','',7);
                                if(strlen(iconv('UTF-8','ISO-8859-1',$militar['MilitarsEscala']['codigo']))>4){
        				$this->SetFont('Arial','',6);
                                    
                                }
				$this->MultiCell($tm1,4,iconv('UTF-8','ISO-8859-1',$militar['MilitarsEscala']['codigo']),1,'C',1);
				$this->SetFont('Arial','',7);
				$x+=$tm1;
				$this->SetXY($x,$ini);
				if(strlen($militar[0]['nome'])>15){
					$this->SetFont('Arial','',5);
					$this->MultiCell($tm2,4,iconv('UTF-8','ISO-8859-1',$militar[0]['nome']),1,'C');
					$this->SetFont('Arial','',7);
				}else{
					$this->MultiCell($tm2,4,iconv('UTF-8','ISO-8859-1',$militar[0]['nome']),1,'C');
				}
				$x+=$tm2;
				$this->SetXY($x,$ini);
				$this->MultiCell($tm3,4,iconv('UTF-8','ISO-8859-1',$militar['Militar']['indicativo']),1,'C');
				$x+=$tm3;
			...
			if($n>0){
				 ...
				 */
				for($i=$n;$i<$qtdlegendas;$i++){
					$this->SetXY($x,$ini);
					$this->SetFont('Arial','',7);
					$this->MultiCell($tm1,4,'',1,'C',1);
					$x+=$tm1;
					$this->SetXY($x,$ini);
					$this->MultiCell($tm2,4,'',1,'C');
					$x+=$tm2;
					$this->SetXY($x,$ini);
					$this->MultiCell($tm3,4,'',1,'C');
					$x+=$tm3;
				}
		...
		if($podeexibirrascunho==1){
			...
			if(((preg_match($p1, $t01))||(preg_match($p2, $t01))||(preg_match($p3, $t01)))&&($novoPDF<=200908)){
				...
				//if(!empty($assinacomandante)){	$assinatura_comandante = 'img/assinaturacmt.jpg';		}
			}
		...
		if($selprev=='p'){
			...
			$obs1 = $versos[0]['Versoescala']['item1'];
			//$obs2 = $versos[0]['Versoescala']['naoconformidades']." | ".$versos[0]['Versoescala']['item2'];
			$obs2 = str_replace('undefined','',$versos[0]['Versoescala']['naoconformidades'])." | ".str_replace('undefined','',$versos[0]['Versoescala']['item2']);
			$obs3 = $versos[0]['Versoescala']['item3'];
		}else{
			...
			$obs1 = $versos[0]['Versoescala']['item4'];
			$obs2 = str_replace("\n",'  ',$versos[0]['Versoescala']['naoconformidades'])." | ".str_replace("\n",'  ',$versos[0]['Versoescala']['item5']);
			$obs3 = $versos[0]['Versoescala']['item6'];
		}
		...
		foreach($afastamento as $afastado){
			...
			if((preg_match($p601, $t01))){
				if($anterior.$motivoanterior==$afastado[0]['nome'].$t01){
					$item601 .= ', de '.strftime('%d/%m/%Y',strtotime($afastado['Afastamento']['dt_inicio'])).' até '.strftime('%d/%m/%Y',strtotime($afastado['Afastamento']['dt_termino'])).' por '.$afastado['Afastamento']['hora_extra'].' hora(s) '.$comentarios;
				}else{
					$conta601 ++;
					$item601 .= "\r\n";
					$item601 .= $afastado[0]['nome'].' - '.' de '.strftime('%d/%m/%Y',strtotime($afastado['Afastamento']['dt_inicio'])).' até '.strftime('%d/%m/%Y',strtotime($afastado['Afastamento']['dt_termino'])).' por '.$afastado['Afastamento']['hora_extra'].' hora(s) '.$comentarios;
				}
			}
			$anterior = $afastado[0]['nome'];
			$motivoanterior=strtoupper($afastado['Afastamento']['motivo']);
		...
		foreach($afastamento as $afastado){
			...
			if((preg_match($p701, $t01))){
				if($anterior.$motivoanterior==$afastado[0]['nome'].$t01){
					$item701 .= ', de '.strftime('%d/%m/%Y',strtotime($afastado['Afastamento']['dt_inicio'])).' até '.strftime('%d/%m/%Y',strtotime($afastado['Afastamento']['dt_termino'])).' por '.$afastado['Afastamento']['hora_extra'].' hora(s) '.$comentarios;
				}else{
					$conta701 ++;
					$item701 .= "\r\n";
					$item701 .= $afastado[0]['nome'].' - '.' de '.strftime('%d/%m/%Y',strtotime($afastado['Afastamento']['dt_inicio'])).' até '.strftime('%d/%m/%Y',strtotime($afastado['Afastamento']['dt_termino'])).' por '.$afastado['Afastamento']['hora_extra'].' hora(s) '.$comentarios;
				}
			}
			$anterior = $afastado[0]['nome'];
			$motivoanterior=strtoupper($afastado['Afastamento']['motivo']);
		...
		foreach($afastamento as $afastado){
			...
			if((preg_match($p801, $t01))){
				if($anterior.$motivoanterior==$afastado[0]['nome'].$t01){
					$item801 .= ', de '.strftime('%d/%m/%Y',strtotime($afastado['Afastamento']['dt_inicio'])).' até '.strftime('%d/%m/%Y',strtotime($afastado['Afastamento']['dt_termino'])).' por '.$afastado['Afastamento']['hora_extra'].' hora(s) '.$comentarios;
				}else{
					$conta801 ++;
					$item801 .= "\r\n";
					$item801 .= $afastado[0]['nome'].' - '.' de '.strftime('%d/%m/%Y',strtotime($afastado['Afastamento']['dt_inicio'])).' até '.strftime('%d/%m/%Y',strtotime($afastado['Afastamento']['dt_termino'])).' por '.$afastado['Afastamento']['hora_extra'].' hora(s) '.$comentarios;
				}
			}
			$anterior = $afastado[0]['nome'];
			$motivoanterior=strtoupper($afastado['Afastamento']['motivo']);
		...
		foreach($afastamento as $afastado){
			...
			if((preg_match($p901, $t01))){
				if($anterior.$motivoanterior==$afastado[0]['nome'].$t01){
					$item901 .= ', de '.strftime('%d/%m/%Y',strtotime($afastado['Afastamento']['dt_inicio'])).' até '.strftime('%d/%m/%Y',strtotime($afastado['Afastamento']['dt_termino'])).' por '.$afastado['Afastamento']['hora_extra'].' hora(s) '.$comentarios;
				}else{
					$conta901 ++;
					$item901 .= "\r\n";
					$item901 .= $afastado[0]['nome'].' - '.' de '.strftime('%d/%m/%Y',strtotime($afastado['Afastamento']['dt_inicio'])).' até '.strftime('%d/%m/%Y',strtotime($afastado['Afastamento']['dt_termino'])).' por '.$afastado['Afastamento']['hora_extra'].' hora(s) '.$comentarios;
				}
			}
			$anterior = $afastado[0]['nome'];
			$motivoanterior=strtoupper($afastado['Afastamento']['motivo']);
		...
		foreach($afastamento as $afastado){
			...
			if((preg_match($p1001, $t01))){
				if($anterior.$motivoanterior==$afastado[0]['nome'].$t01){
					$item1001 .= ', de '.strftime('%d/%m/%Y',strtotime($afastado['Afastamento']['dt_inicio'])).' até '.strftime('%d/%m/%Y',strtotime($afastado['Afastamento']['dt_termino'])).' por '.$afastado['Afastamento']['hora_extra'].' hora(s) '.$comentarios;
				}else{
					$conta1001 ++;
					$item1001 .= "\r\n";
					$item1001 .= $afastado[0]['nome'].' - '.' de '.strftime('%d/%m/%Y',strtotime($afastado['Afastamento']['dt_inicio'])).' até '.strftime('%d/%m/%Y',strtotime($afastado['Afastamento']['dt_termino'])).' por '.$afastado['Afastamento']['hora_extra'].' hora(s) '.$comentarios;
				}
			}
			$anterior = $afastado[0]['nome'];
			$motivoanterior=strtoupper($afastado['Afastamento']['motivo']);
		...
		$this->SetFont('Arial','',6);
		if(strlen($versos[0]['Versoescala']['adjuntos'])>4){
			$versos[0]['Versoescala']['adjunto_obs']=str_replace('–','-',$versos[0]['Versoescala']['adjunto_obs']);
			$this->MultiCell($tampagina,4,iconv('UTF-8','ISO-8859-1',''.$versos[0]['Versoescala']['adjuntos'].' - '.$versos[0]['Versoescala']['adjunto_obs']."\r\n"),0,'L',0);
		}else{
		...
		if($conta901>0){
			if($conta901>0){
				$this->SetXY(20,$this->GetY()-4);
				$this->MultiCell($tampagina,4,iconv('UTF-8','ISO-8859-1',$item901."\r\n"),0,'L',0);
			}
		}	
		...
		if($conta601>0){
			if($conta601>0){
				$this->SetXY(20,$this->GetY()-4);
				$this->MultiCell($tampagina,4,iconv('UTF-8','ISO-8859-1',$item601."\r\n"),0,'L',0);
			}
		}	
		if($conta801>0){
			if($conta801>0){
				$this->SetXY(20,$this->GetY()-4);
				$this->MultiCell($tampagina,4,iconv('UTF-8','ISO-8859-1',$item801."\r\n"),0,'L',0);
			}
		}	
		...
		if($conta1001>0){
			if($conta1001>0){
				$this->SetXY(20,$this->GetY()-4);
				$this->MultiCell($tampagina,4,iconv('UTF-8','ISO-8859-1',$item1001."\r\n"),0,'L',0);
			}
		}	
		...
		if(!empty($idescalante)){
		    ...
		    $this->MultiCell($tampagina,4,iconv('UTF-8','ISO-8859-1','ASSINATURA ELETRÔNICA Nº '.crc32($idescalante)),0,'R',0);
		    $this->SetFont('Arial','',6);
		    $this->SetX($x_anterior); $this->SetY($y_anterior);
		}
		...
		if(!empty($idchefe)){
		    ...
		    $this->SetFont('Arial','',5);
		    $this->SetXY($x_anterior,$y_anterior);
		    $this->MultiCell($tampagina,4,iconv('UTF-8','ISO-8859-1','ASSINATURA ELETRÔNICA Nº '.crc32($idchefe)),0,'R',0);
		    $this->SetFont('Arial','',6);
		    $this->SetX($x_anterior); $this->SetY($y_anterior);
		}
		...
		//if(!empty($assinatura_comandante)){ 	$this->Image($assinatura_comandante,140,$this->GetY(),40,5.7);	}
		...
		if(!empty($assinacomandante)){
		    ...
		    $this->SetFont('Arial','',5);
		    $this->SetXY($x_anterior,$y_anterior);
		    $this->MultiCell($tampagina,4,iconv('UTF-8','ISO-8859-1','ASSINATURA ELETRÔNICA Nº '.crc32($assinacomandante)),0,'R',0);
		    $this->SetFont('Arial','',6);
		    $this->SetX($x_anterior); $this->SetY($y_anterior);
		}
		/*
		if(!empty($idcheferegional)){
		    ...
		    $this->SetFont('Arial','',5);
		    $this->SetXY($x_anterior,$y_anterior);
		    $this->MultiCell($tampagina,4,iconv('UTF-8','ISO-8859-1','ASSINATURA ELETRÔNICA Nº '.$idcheferegional),0,'R',0);
		    $this->SetFont('Arial','',6);
		    $this->SetX($x_anterior); $this->SetY($y_anterior);
		}
		*/
...
//------------------------------------------------------------------------------------------------------------
		...
		foreach ($legendas as $militar){
			...
			*/
			...
			if($milico[$militar['Militar']['id']]['horas']>=$preenche[0]['EscalasMonth']['carga_maxima']){
				$this->SetFillColor(101,174,55);
			}

			if($milico[$militar['Militar']['id']]['horas']<=$preenche[0]['EscalasMonth']['carga_base']){
				$this->SetFillColor(229,121,55);
			}
...
//------------------------------------------------------------------------------------------------------------
		...
		$this->SetXY(10,$ini);
		$larguratotal =$tampagina+15;
		$this->MultiCell($larguratotal,4,iconv('UTF-8','ISO-8859-1',"CARGA DE TRABALHO MENSAL"),1,'C',0);
		...
		$this->Cell(12,4,iconv('UTF-8','ISO-8859-1','CTOE'),1,0,'C',1);
		$this->Cell(12,4,iconv('UTF-8','ISO-8859-1','CTOp'),1,0,'C',1);
		$this->Cell(6,4,iconv('UTF-8','ISO-8859-1','CTR'),1,0,'C',1);
		$this->Cell(8,4,iconv('UTF-8','ISO-8859-1','CTP'),1,0,'C',1);
		$this->Cell(14,4,iconv('UTF-8','ISO-8859-1','CTM'),1,0,'C',1);
		...
		foreach ($legendas as $militar){
			...
			$milico[$militar['Militar']['id']]['risaer'] = 0;
			$milico[$militar['Militar']['id']]['hora_extra']= 0;
			$milico[$militar['Militar']['id']]['ctoe'] = 0;


			foreach($afastamento as $afastado){
					if($afastado['Militar']['id']==$militar['Militar']['id']){
						$p21 = '/OFICIAL/i';
						$t01 = strtoupper($afastado['Afastamento']['motivo']);
						if(preg_match($p21, $t01)){
							$milico[$militar['Militar']['id']]['risaer']= $milico[$militar['Militar']['id']]['risaer'] + 24;
						}
						$p21 = '/SARGENTO/i';
						$t01 = strtoupper($afastado['Afastamento']['motivo']);
						if(preg_match($p21, $t01)){
						...
						$t01 = strtoupper($afastado['Afastamento']['motivo']);
						if(preg_match($p21, $t01)){
							$milico[$militar['Militar']['id']]['risaer']= $milico[$militar['Militar']['id']]['risaer'] + $afastado['Afastamento']['hora_extra'];
						}
						$p21 = '/HORAS/i';
						$t01 = strtoupper($afastado['Afastamento']['motivo']);
						if(preg_match($p21, $t01)){
							$milico[$militar['Militar']['id']]['hora_extra'] += $afastado['Afastamento']['hora_extra'];
						}
						$p21 = '/CTP/i';
						$t01 = strtoupper($afastado['Afastamento']['motivo']);
						if(preg_match($p21, $t01)){
						...
						$t01 = strtoupper($afastado['Afastamento']['motivo']);
						if(preg_match($p21, $t01)){
							$milico[$militar['Militar']['id']]['ctoe'] += $afastado['Afastamento']['hora_extra'];
						}
					}
			}
			$grafico[$contagrafico]['legenda'] = $milico[$militar['Militar']['id']]['codigo'];
			$grafico[$contagrafico]['horas'] = $milico[$militar['Militar']['id']]['risaer']+$milico[$militar['Militar']['id']]['horas']+$milico[$militar['Militar']['id']]['hora_extra']+$milico[$militar['Militar']['id']]['ctoe'];
			
			$contagrafico ++;


			if($maximo<($milico[$militar['Militar']['id']]['risaer']+$milico[$militar['Militar']['id']]['horas']+$milico[$militar['Militar']['id']]['hora_extra']+$milico[$militar['Militar']['id']]['ctoe'])){
				$maximo = $milico[$militar['Militar']['id']]['risaer']+$milico[$militar['Militar']['id']]['horas']+$milico[$militar['Militar']['id']]['hora_extra']+$milico[$militar['Militar']['id']]['ctoe'];
			}			
			
			foreach($turnos as $turno){
				$total += $milico[$militar['Militar']['id']][$turno['Turno']['id']]['qtd'];
			}
			if(($milico[$militar['Militar']['id']]['risaer']+$milico[$militar['Militar']['id']]['horas']+$milico[$militar['Militar']['id']]['hora_extra']+$milico[$militar['Militar']['id']]['ctoe'])>$preenche[0]['EscalasMonth']['carga_maxima']){
				$this->SetFillColor(240,0,0);
			}

			if(($milico[$militar['Militar']['id']]['risaer']+$milico[$militar['Militar']['id']]['horas']+$milico[$militar['Militar']['id']]['hora_extra']+$milico[$militar['Militar']['id']]['ctoe'])<$preenche[0]['EscalasMonth']['carga_base']){
				$this->SetFillColor(240,0,0);
			}
			...
			$this->SetFont('Arial','',6);
			if($max>450){
				$this->Cell(12,3,iconv('UTF-8','ISO-8859-1',round($milico[$militar['Militar']['id']]['ctoe'],2)),1,0,'C',1);
			}else{
				$this->Cell(12,4,iconv('UTF-8','ISO-8859-1',round($milico[$militar['Militar']['id']]['ctoe'],2)),1,0,'C',1);
			}

			if($max>450){
				$this->Cell(12,3,iconv('UTF-8','ISO-8859-1',round($milico[$militar['Militar']['id']]['horas'],2)),1,0,'C',1);
			}else{
				$this->Cell(12,4,iconv('UTF-8','ISO-8859-1',round($milico[$militar['Militar']['id']]['horas'],2)),1,0,'C',1);
			}


			
			
			$this->Cell(6,4,iconv('UTF-8','ISO-8859-1',round($milico[$militar['Militar']['id']]['risaer'],2)),1,0,'C',1);
			$this->Cell(8,4,iconv('UTF-8','ISO-8859-1',round($milico[$militar['Militar']['id']]['hora_extra'],2)),1,0,'C',1);

			$this->SetFont('Arial','',8);
			$this->Cell(14,4,iconv('UTF-8','ISO-8859-1',round($milico[$militar['Militar']['id']]['risaer']+$milico[$militar['Militar']['id']]['horas']+$milico[$militar['Militar']['id']]['hora_extra']+$milico[$militar['Militar']['id']]['ctoe'],2)),1,0,'C',1);
...
//------------------------------------------------------------------------------------------------------------
		...
		for($x=0;$x<$contagrafico;$x++){
			...
			if($grafico[$x]['horas']>$preenche[0]['EscalasMonth']['carga_maxima']){
				$this->SetDrawColor(240,0,0);
			}

			if($grafico[$x]['horas']<$preenche[0]['EscalasMonth']['carga_base']){
				$this->SetDrawColor(240,0,0);
			}
...
//				if(preg_match("/R\/R/",$milico[$militar['Militar']['id']]['postograd'])!=1 && strpos($milico[$militar['Militar']['id']]['postograd'],'DACTA')===false && strpos($milico[$militar['Militar']['id']]['postograd'],'R1')===false){
                            //preg_match("/R\/R/",$milico[$militar['Militar']['id']]['postograd'])!=1 && preg_match("/R1/",$milico[$militar['Militar']['id']]['postograd'])!=1   && 
				if(preg_match("/DACTA/",$milico[$militar['Militar']['id']]['postograd'])!=1  && preg_match("/CV/",$milico[$militar['Militar']['id']]['postograd'])!=1){
					foreach($turnos as $turno){
						if($t[$turno['Turno']['id']]['horas']>8 && $t[$turno['Turno']['id']]['horas']<24 && $turno['Turno']['rotulo']!='SOMBRA'){
							if(!empty($milico[$militar['Militar']['id']][$turno['Turno']['id']]['dias'])){
								...
								if(count($numerosfiltro)>0){
									$numeros = (count($numerosfiltro)*1.3)*2;
...
if( $ignorarr && preg_match("/DACTA/",$milico[$militar['Militar']['id']]['postograd'])!=1  && preg_match("/CV/",$milico[$militar['Militar']['id']]['postograd'])!=1  &&  $milico[$militar['Militar']['id']]['ativa']){
	...
	function LivroEletronico($escala, $preenche, $turnos, $legendas, $unidade, $dtm, $dta, $selprev, $versos, $afastamento, $consultasql,$podeexibirrascunho)
	{
	...
	function fichaPropostaPAEAT($anoPaeat, $unidadeResponsavel, $siat, $chefe, $divisaoSolicitante, $dados)
	{
		...
		$caminho = str_replace('views/helpers','',$caminho);
              ...
              //  print_r($dados['Curso']);exit();


		//$this->AddPage();
		$totalpaginas = count($dados['Curso']);
		$paginasconta = 0;
		foreach($dados['Curso'] as $curso=>$detalhes){
			...
			if(($detalhes['totalvagas']>0)){
				...
				if(file_exists($caminho.'webroot/img/decea.jpg')){
					$this->Image($caminho.'webroot/img/decea.jpg',20.5,20.5,10,10);
				}
				if(file_exists($caminho.'webroot/img/cindacta4.jpg')){
					$this->Image($caminho.'webroot/img/cindacta4.jpg',177,20.5,10,10);
				}
				$this->SetFont('Arial','B',13);
				$this->Cell(168,8,iconv('UTF-8','ISO-8859-1',"QUARTO CENTRO INTEGRADO DEFESA AÉREA E"),0,0,'C',0);
				$this->ln();
				$this->Cell(168,8,iconv('UTF-8','ISO-8859-1',"CONTROLE DE TRÁFEGO AÉREO"),0,0,'C',0);
				$this->ln();
				$this->SetFont('Arial','B',10);
				$this->Cell(168,8,iconv('UTF-8','ISO-8859-1',"FICHA DE PROPOSTA DE INCLUSÃO DE CURSO NO PAEAT ".$anoPaeat),1,0,'C',0);
				...
				$this->ln();
				$this->SetFont('Arial','B',10);
				$this->Cell(30,8,iconv('UTF-8','ISO-8859-1',"SOLICITANTE:"),0,0,'L',0);
				$this->SetFont('Arial','',10);
				$this->Cell(138,8,iconv('UTF-8','ISO-8859-1',$detalhes['divisao_solicitante']),0,0,'L',0);
				...
				$y = $this->GetY();
				$this->SetFont('Arial','',10);
				$this->Cell(50,16,'',1,0,'L',0);
				$this->Cell(118,16,'',1,0,'L',0);
				$this->SetXY($x,$y);
				//$this->Cell(60,6,iconv('UTF-8','ISO-8859-1','CÓDIGO:'."\r\n"),0,0,'L',0);
				//$this->Cell(108,6,iconv('UTF-8','ISO-8859-1','NOME:'),0,0,'L',0);

				$this->SetFont('Arial','B',10);
				$this->Cell(168,8,iconv('UTF-8','ISO-8859-1',"CÓDIGO:                                     CURSO:"),0,0,'L',0);
				$this->SetFont('Arial','',10);
				$this->SetXY(3,$y);
				$this->MultiCell(50,8,iconv('UTF-8','ISO-8859-1',trim($detalhes['codigo'])),0,0,'L',0);
				$this->SetXY(87,$y);
				$this->MultiCell(98,8,iconv('UTF-8','ISO-8859-1',trim($detalhes['descricao'])),0,'L',0);
				...
				$this->SetXY($x,$y);
				$this->SetFont('Arial','B',10);
				$this->Cell(168,8,iconv('UTF-8','ISO-8859-1',"VAGAS NECESSÁRIAS:"),0,0,'L',0);
				$this->SetXY($x,$y);
				$this->SetFont('Arial','',10);
				$this->Cell(168,8,iconv('UTF-8','ISO-8859-1',"                                          ".$detalhes['totalvagas']),0,0,'L',0);
			...
			//	$this->Cell(168,8,iconv('UTF-8','ISO-8859-1',"VAGAS NECESSÁRIAS:   ".$detalhes['totalvagas']),0,0,'l',0);
				...
				$y = $this->GetY();
				$this->SetFont('Arial','B',10);
				$this->Cell(36,6,'',0,0,'R',0);
				$this->Cell(6,6,'',0,0,'R',0);
				$this->Cell(42,6,iconv('UTF-8','ISO-8859-1',"AJUDA CUSTO"),0,0,'C',0);
				$this->Cell(42,6,iconv('UTF-8','ISO-8859-1',"DIÁRIAS"),0,0,'C',0);
				$this->Cell(42,6,'PASSAGENS',0,0,'C',0);
				$this->SetFont('Arial','',10);
				$this->SetXY($x,$y);
				$this->ln();

				foreach($detalhes['unidades'] as $conteudo){
					$this->Cell(36,6,iconv('UTF-8','ISO-8859-1',$conteudo['nome']),0,0,'L',0);
					$this->Cell(6,6,iconv('UTF-8','ISO-8859-1',$conteudo['vagas']),0,0,'R',0);
					$this->Cell(42,6,iconv('UTF-8','ISO-8859-1','R$ '.number_format($detalhes['valor_ajuda_custo'], 2, ',', '.')),0,0,'C',0);
					$this->Cell(42,6,iconv('UTF-8','ISO-8859-1','R$ '.number_format($detalhes['valor_diaria'], 2, ',', '.')),0,0,'C',0);
					$this->Cell(42,6,iconv('UTF-8','ISO-8859-1','R$ '.number_format($detalhes['valor_passagem'], 2, ',', '.')),0,0,'C',0);
					$this->ln();
				}
				...
				$this->Cell(168,4,iconv('UTF-8','ISO-8859-1',$chefe),0,'R',0);
				$this->ln();
				$this->Cell(168,4,iconv('UTF-8','ISO-8859-1',$divisaoSolicitante),0,'R',0);
				$this->Rect(20,20,168,260);
				if($totalpaginas>$paginasconta){
					$this->AddPage();
				}
			}
		}
	...
	function relatorioEscala($escala, $mes, $selprev)
	{
		...
		foreach ($escala as $dados){
			...
			$this->Cell(65,4,iconv('UTF-8','ISO-8859-1',$dados['Setor']['sigla_setor'].' - mês:'.$dados['Escala']['mes']),1,0,'R',1);
	...
	function Footer() { //Position at 1.5 cm from bottom
		...
		if($this->controle_rodape==0){
			//	$this->Cell(0,10,iconv('UTF-8','ISO-8859-1','SGBDO v. 0.5   Pág.: ').$this->PageNo().' / {nb} --------> Gerado automaticamente pelo sistema desenvolvido no CINDACTA IV - SO BET EVALDO (c) 2008',0,0,'C');
		}else{
...
//	function EscalaConferencia($escala, $preenche, $turnos, $legendas, $unidade, $dtm, $dta, $selprev, $versos, $afastamento, $consultasql,$privilegios)
