<?php
//App::import('Vendor','Spreadsheet/Excel/Writer/Writer');


set_time_limit(100); // Set maximum execution time to 10 seconds.
...
class excelHelper extends Spreadsheet_Excel_Writer {
  var $workbook;
...
function MysqlDatetimeToExcel($datetime) {
  ...
  function OutputFile() {
    $this->workbook->Close();
    echo file_get_contents($this->workbook->_filename, "rb");
  }
}
?>