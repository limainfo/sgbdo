...
echo $form->create('Escala', array('action'=>'externoespelhopdf','onsubmit'=>'javascript:pdf();return false;','type'=>'file'));
echo $form->select('ano', $escalasmonth ,null ,array('onChange'=>'javascript:listaescalas(\'EscalaAno\',\'EscalaEscala\',\'EscalaDia\');','class'=>'formulario','style'=>'vertical-align:top;'), false);
echo $form->select('escala',null ,null,array('onChange'=>'','class'=>'formulario','multiple'=>'multiple','size'=>'12'), false);
echo $form->select('dia',null,null ,array('onChange'=>'','class'=>'formulario','style'=>'vertical-align:top;'), false).'<input type="submit" value="gerarPdf" class="botoes" style="vertical-align:top;">';
