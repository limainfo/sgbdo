...
<div class="empreendimentos index">
	<h1><?php __('Empreendimentos');?>	&nbsp;<?php echo $this->Html->link($this->Html->image('broffice.png', array('alt'=> __('BROffice', true), 'border'=> '0', 'title'=>'Dados em planilha BROffice', 'onmouseover'=>"\$('busca').action='".$this->webroot."empreendimentos/indexExcel/';", 'onclick'=>'$("busca").submit();' )), '#', array('id'=>'broffice','escape'=>false), null,false); ?>	
	...
	<?php echo $form->create('formFind', array('url' => 'index','type'=>'file','action' => 'index','controller' => 'empreendimentos','id'=>'busca','onsubmit'=>'sql();')); ?>	
	<h3>
	<?php
...
<?php
		...
		echo '</select>&nbsp;&nbsp;&nbsp;<img border="0" onclick="ShowContent(\'filtro\');"  title="Filtrar Dados" alt="Filtro" src="'.$this->webroot.'img/filtro.gif"  onmouseover="$(\'busca\').action=\''.$this->webroot.'empreendimentos/index/\';"/></div>'; ?>
...
?>
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('controle');?></th>
	...
	?>
	<tr<?php echo $class;?>>
		<td><?php echo $empreendimento['Empreendimento']['id']; ?>&nbsp;</td>
		<td><?php echo $empreendimento['Empreendimento']['controle']; ?>&nbsp;</td>
		<td><?php echo $empreendimento['Empreendimento']['localidade']; ?>&nbsp;</td>
		<td><?php echo $empreendimento['Empreendimento']['projeto']; ?>&nbsp;</td>
		<td><?php echo $empreendimento['Empreendimento']['tarefa']; ?>&nbsp;</td>
		<td><?php echo $empreendimento['Empreendimento']['prazo']; ?>&nbsp;</td>
		<td><?php echo $empreendimento['Empreendimento']['responsavel']; ?>&nbsp;</td>
		<td><?php echo $empreendimento['Empreendimento']['status']; ?>&nbsp;</td>
		<td><?php echo $empreendimento['Empreendimento']['observacao']; ?>&nbsp;</td>
		<td class="actions">

		<?php echo $this->Html->link($this->Html->image('lupa.gif', array('alt'=> __('Exibir', true), 'border'=> '0', 'title'=>'Visualizar')), array('action'=>'view', $empreendimento['Empreendimento']['id']),array('escape'=>false, 'escape'=>false), null,false); ?>

		<?php echo $this->Html->link($this->Html->image('lapis.gif', array('alt'=> __('Editar', true), 'border'=> '0', 'title'=>'Editar')), array('action'=>'edit', $empreendimento['Empreendimento']['id']),array('escape'=>false, 'escape'=>false), null,false); ?>
