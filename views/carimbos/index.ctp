...
<div class="carimbos index">
	<h1><?php __('Carimbos');?>	&nbsp;<?php echo $this->Html->link($this->Html->image('broffice.png', array('alt'=> __('BROffice', true), 'border'=> '0', 'title'=>'Dados em planilha BROffice', 'onmouseover'=>"\$('busca').action='".$this->webroot."carimbos/indexExcel/';", 'onclick'=>'$("busca").submit();' )), '#', array('id'=>'broffice','escape'=>false), null,false); ?>	
	...
	<?php echo $form->create('formFind', array('url' => 'index','type'=>'file','action' => 'index','controller' => 'carimbos','id'=>'busca','onsubmit'=>'sql();')); ?>	
	<h3>
	<?php
...
<?php
		...
		echo '</select>&nbsp;&nbsp;&nbsp;<img border="0" onclick="ShowContent(\'filtro\');"  title="Filtrar Dados" alt="Filtro" src="'.$this->webroot.'img/filtro.gif"  onmouseover="$(\'busca\').action=\''.$this->webroot.'carimbos/index/\';"/></div>'; ?>
...
?>
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('emitente');?></th>
	...
	?>
	<tr<?php echo $class;?>>
		<td><?php echo $carimbo['Carimbo']['id']; ?>&nbsp;</td>
		<td><?php echo $carimbo['Carimbo']['emitente']; ?>&nbsp;</td>
		<td><?php echo $carimbo['Carimbo']['funcao']; ?>&nbsp;</td>
		<td><?php echo $carimbo['Carimbo']['type']; ?>&nbsp;</td>
		<td><?php echo $carimbo['Carimbo']['name']; ?>&nbsp;</td>
		<td><?php echo $carimbo['Carimbo']['size']; ?>&nbsp;</td>
		<td<?php echo $td;?>><?php
			$img = $carimbo['Carimbo']['id'];
		    echo $this->Html->image(array('controller'=> 'carimbos', 'action'=>'externodownload',$img), array( 'border'=> '0' ,'width'=>'40', 'height'=>'30')); //  
		?>
		</td>
		<td><?php echo $carimbo['Carimbo']['created']; ?>&nbsp;</td>
		<td><?php echo $carimbo['Carimbo']['updated']; ?>&nbsp;</td>
		<td class="actions">

		<?php echo $this->Html->link($this->Html->image('lupa.gif', array('alt'=> __('Exibir', true), 'border'=> '0', 'title'=>'Visualizar')), array('action'=>'view', $carimbo['Carimbo']['id']),array('escape'=>false, 'escape'=>false), null,false); ?>

		<?php echo $this->Html->link($this->Html->image('lapis.gif', array('alt'=> __('Editar', true), 'border'=> '0', 'title'=>'Editar')), array('action'=>'edit', $carimbo['Carimbo']['id']),array('escape'=>false, 'escape'=>false), null,false); ?>
