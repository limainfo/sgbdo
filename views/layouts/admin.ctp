...
*/
   //     echo '<pre>'.print_r($u,true).'</pre>';
		...
		//echo("<a href='".$this->webroot.'escalas/externocalendario'."'>calendário de escalas</a>");
		...
		//echo("<a href='".$this->webroot.'setors'."'>habilitação</a>");
		//echo("<a href='".$this->webroot.'aditivos/externoindicacoes'."' target='_blank'>indicações em cursos</a>");
		...
		//echo("<span class='qmdivider qmdividerx'></span>");
		echo("<span class='qmtitle'>Atualizações</span>");
		...
		if(!empty($acesso['usuarios'])&&!empty($acesso['privilegios'])&&!empty($acesso['tabelas'])){echo("<a href='".$this->webroot.'usuarios/add'."'>Usuários</a>");}
		//if(!empty($acesso['logs'])){echo("<a href='".$this->webroot.'logs'."'>Auditoria</a>");}
                //CadaCons(!empty($acesso['assinaturas']),'Assinatura',$this->webroot.'assinaturas');
                CadaCons(!empty($acesso['cursos']),'Curso',$this->webroot.'cursos');
	...
	if(($compara==1)||($compara==4)){
		...
		//if(!empty($acesso['logs'])){echo("<a href='".$this->webroot.'logs'."'>Auditoria</a>");}
                if($compara==1){
                       echo("<span class='qmdivider qmdividerx'></span><span class='qmtitle'>Orçamento</span>");
			...
			*/
			...
			//echo("<span class='qmdivider qmdividerx'></span><span class='qmtitle'>Inspeções / BCA</span>");
		...
		echo("<span class='qmdivider qmdividery'></span><a href='javascript:void(0)'>Chefe Divisão</a>");
		echo("<div><span class='qmdivider qmdividerx'></span> ");
		echo("<span class='qmtitle'>Cadastros</span>");
		if(!empty($acesso['unidades'])){echo("<a href='".$this->webroot.'unidades'."'>Unidades</a>");}
		if(!empty($acesso['setors'])){echo("<a href='".$this->webroot.'setors'."'>Setores</a>");}
		...
		echo("<div><span class='qmdivider qmdividerx'></span> ");
                ...
                if((!empty($acesso['escalas']))||(!empty($acesso['escalasmonths']))||(!empty($acesso['turnos']))){
                    ...
                    //echo("<a href='{$this->webroot}licencas/'>Licenças</a> ");
					...
					if(($compara!=3)){       echo("<a href='{$this->webroot}compensacaos/add'>Compensação Orgânica</a> "); }
                    ...
                    echo("<a href='{$this->webroot}usuarios/add'>Cadastrar usuários</a> ");
