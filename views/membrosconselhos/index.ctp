...
<div class="membrosconselhos index">
	<h1><?php __('Membrosconselhos');?>	&nbsp;<?php echo $this->Html->link($this->Html->image('broffice.png', array('alt'=> __('BROffice', true), 'border'=> '0', 'title'=>'Dados em planilha BROffice', 'onmouseover'=>"\$('busca').action='".$this->webroot."membrosconselhos/indexExcel/';", 'onclick'=>'$("busca").submit();' )), '#', array('id'=>'broffice','escape'=>false), null,false); ?>	
	...
	<?php echo $form->create('formFind', array('url' => 'index','type'=>'file','action' => 'index','controller' => 'membrosconselhos','id'=>'busca','onsubmit'=>'sql();')); ?>	
	<h3>
	<?php
...
<?php
		...
		echo '</select>&nbsp;&nbsp;&nbsp;<img border="0" onclick="ShowContent(\'filtro\');"  title="Filtrar Dados" alt="Filtro" src="'.$this->webroot.'img/filtro.gif"  onmouseover="$(\'busca\').action=\''.$this->webroot.'membrosconselhos/index/\';"/></div>'; ?>
...
?>
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('cargosconselho_id');?></th>
			<th><?php echo $this->Paginator->sort('tipo_licenca');?></th>
			<th><?php echo $this->Paginator->sort('dt_inicio');?></th>
			<th><?php echo $this->Paginator->sort('dt_termino');?></th>
			<th><?php echo $this->Paginator->sort('unidade_id');?></th>
			<th class="actions"><?php __('Ações');?></th>
	</tr>
	<?php
	$i = 0;
	foreach ($membrosconselhos as $membrosconselho):
		$class = null;
		if ($i++ % 2 == 0) {
			$class = ' class="altrow"';
		}
	?>
	<tr<?php echo $class;?>>
		<td><?php echo $membrosconselho['Membrosconselho']['id']; ?>&nbsp;</td>
		<td>
		...
		<td><?php echo $membrosconselho['Membrosconselho']['tipo_licenca']; ?>&nbsp;</td>
		<td><?php echo $membrosconselho['Membrosconselho']['dt_inicio']; ?>&nbsp;</td>
		<td><?php echo $membrosconselho['Membrosconselho']['dt_termino']; ?>&nbsp;</td>
		<td>
		...
		<?php echo $this->Html->link($this->Html->image('lupa.gif', array('alt'=> __('Exibir', true), 'border'=> '0', 'title'=>'Visualizar')), array('action'=>'view', $membrosconselho['Membrosconselho']['id']),array('escape'=>false, 'escape'=>false), null,false); ?>

		<?php echo $this->Html->link($this->Html->image('lapis.gif', array('alt'=> __('Editar', true), 'border'=> '0', 'title'=>'Editar')), array('action'=>'edit', $membrosconselho['Membrosconselho']['id']),array('escape'=>false, 'escape'=>false), null,false); ?>
