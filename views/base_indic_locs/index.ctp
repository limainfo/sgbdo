...
<div class="baseIndicLocs index">
	<h1><?php __('Base Indic Locs');//?>	&nbsp;<?php echo $html->link($html->image('broffice.png', array('alt'=> __('BROffice', true), 'border'=> '0', 'title'=>'Dados em planilha BROffice', 'onmouseover'=>"\$('busca').action='".$this->webroot."baseIndicLocs/indexExcel/';", 'onclick'=>'$("busca").submit();' )), '#', array('id'=>'broffice','escape'=>false), null,false); ?>	
	...
	<?php echo $form->create('formFind', array('url' => 'index','type'=>'file','action' => 'index','controller' => 'baseIndicLocs','id'=>'busca','onsubmit'=>'sql();')); ?>	
	<h3>
	<?php
...
<?php
		...
		echo '</select>&nbsp;&nbsp;&nbsp;<img border="0" onclick="ShowContent(\'filtro\');"  title="Filtrar Dados" alt="Filtro" src="'.$this->webroot.'img/filtro.gif"  onmouseover="$(\'busca\').action=\''.$this->webroot.'baseIndicLocs/index/\';"/></div>'; ?>
...
?>
	...
	<?php
	$i = 0;
	foreach ($baseIndicLocs as $baseIndicLoc):
		$class = null;
		if ($i++ % 2 == 0) {
			$class = ' class="altrow"';
		}
	?>
	<tr<?php echo $class;?>>
		<td><?php echo $baseIndicLoc['BaseIndicLoc']['id']; ?>&nbsp;</td>
		<td><?php echo $baseIndicLoc['BaseIndicLoc']['indicativo']; ?>&nbsp;</td>
		<td><?php echo $baseIndicLoc['BaseIndicLoc']['descricao']; ?>&nbsp;</td>
		<td class="actions">

		<?php echo $html->link($html->image('lupa.gif', array('alt'=> __('Exibir', true), 'border'=> '0', 'title'=>'Visualizar')), array('action'=>'view', $baseIndicLoc['BaseIndicLoc']['id']),array('escape'=>false, 'escape'=>false), null,false); ?>

		<?php echo $html->link($html->image('lapis.gif', array('alt'=> __('Editar', true), 'border'=> '0', 'title'=>'Editar')), array('action'=>'edit', $baseIndicLoc['BaseIndicLoc']['id']),array('escape'=>false, 'escape'=>false), null,false); ?>
