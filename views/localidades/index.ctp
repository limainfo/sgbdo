...
<div class="localidades index">
	<h1><?php __('Localidades');?>	&nbsp;<?php echo $this->Html->link($this->Html->image('broffice.png', array('alt'=> __('BROffice', true), 'border'=> '0', 'title'=>'Dados em planilha BROffice', 'onmouseover'=>"\$('busca').action='".$this->webroot."localidades/indexExcel/';", 'onclick'=>'$("busca").submit();' )), '#', array('id'=>'broffice','escape'=>false), null,false); ?>	
	...
	<?php echo $form->create('formFind', array('url' => 'index','type'=>'file','action' => 'index','controller' => 'localidades','id'=>'busca','onsubmit'=>'sql();')); ?>	
	<h3>
	<?php
...
<?php
		...
		echo '</select>&nbsp;&nbsp;&nbsp;<img border="0" onclick="ShowContent(\'filtro\');"  title="Filtrar Dados" alt="Filtro" src="'.$this->webroot.'img/filtro.gif"  onmouseover="$(\'busca\').action=\''.$this->webroot.'localidades/index/\';"/></div>'; ?>
...
?>
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('sigla_localidade');?></th>
			<th><?php echo $this->Paginator->sort('desc_localidade');?></th>
	...
	?>
	<tr<?php echo $class;?>>
		<td><?php echo $localidade['Localidade']['id']; ?>&nbsp;</td>
		<td><?php echo $localidade['Localidade']['sigla_localidade']; ?>&nbsp;</td>
		<td><?php echo $localidade['Localidade']['desc_localidade']; ?>&nbsp;</td>
		<td class="actions">

		<?php echo $this->Html->link($this->Html->image('lupa.gif', array('alt'=> __('Exibir', true), 'border'=> '0', 'title'=>'Visualizar')), array('action'=>'view', $localidade['Localidade']['id']),array('escape'=>false, 'escape'=>false), null,false); ?>

		<?php echo $this->Html->link($this->Html->image('lapis.gif', array('alt'=> __('Editar', true), 'border'=> '0', 'title'=>'Editar')), array('action'=>'edit', $localidade['Localidade']['id']),array('escape'=>false, 'escape'=>false), null,false); ?>
