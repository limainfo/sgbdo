...
<div class="militarscursoscorrigidos index">
<h1><?php __('Militarscursoscorrigidos');?><?php
$script = "var x=\$('find').value;if(x.blank()){\$('broffice').href='".$this->webroot."Militarscursoscorrigidos/indexExcel/';}else{\$('broffice').href='".$this->webroot."Militarscursoscorrigidos/indexExcel/'+x;}";?>
...
<tr>
	...
	<th><?php echo $paginator->sort('dt_inicio_curso');?></th>
	<th><?php echo $paginator->sort('dt_fim_curso');?></th>
	<th><?php echo $paginator->sort('local_realizacao');?></th>
	<th><?php echo $paginator->sort('documento');?></th>
	<th><?php echo $paginator->sort('periodo');?></th>
	<th><?php echo $paginator->sort('acao');?></th>
	<th><?php echo $paginator->sort('updated');?></th>
	<th class="actions"><?php __('Ações');?></th>
</tr>
<?php
$i = 0;
foreach ($militarscursoscorrigidos as $militarscursoscorrigido):
	$class = null;
	if ($i++ % 2 == 0) {
		$class = ' class="altrow"';
	}
?>
	<tr<?php echo $class;?>>
		<td>
			<?php echo $militarscursoscorrigido['Militarscursoscorrigido']['id']; ?>
		</td>
		<td>
			<?php echo $militarscursoscorrigido['Militarscursoscorrigido']['setor_id']; ?>
		</td>
		<td>
			<?php echo $militarscursoscorrigido['Militarscursoscorrigido']['militar_id']; ?>
		</td>
		<td>
			<?php echo $militarscursoscorrigido['Militarscursoscorrigido']['curso_id']; ?>
		</td>
		<td>
			<?php echo $militarscursoscorrigido['Militarscursoscorrigido']['dt_inicio_curso']; ?>
		</td>
		<td>
			<?php echo $militarscursoscorrigido['Militarscursoscorrigido']['dt_fim_curso']; ?>
		</td>
		<td>
			<?php echo $militarscursoscorrigido['Militarscursoscorrigido']['local_realizacao']; ?>
		</td>
		<td>
			<?php echo $militarscursoscorrigido['Militarscursoscorrigido']['documento']; ?>
		</td>
		<td>
			<?php echo $militarscursoscorrigido['Militarscursoscorrigido']['periodo']; ?>
		</td>
		<td>
			<?php echo $militarscursoscorrigido['Militarscursoscorrigido']['acao']; ?>
		</td>
		<td>
			<?php echo $militarscursoscorrigido['Militarscursoscorrigido']['updated']; ?>
		</td>
		<td class="actions">
			<?php echo $this->Html->link($this->Html->image('lupa.gif', array('alt'=> __('Exibir', true), 'border'=> '0', 'title'=>'Visualizar')), array('action'=>'view', $militarscursoscorrigido['Militarscursoscorrigido']['id']),array('escape'=>false, 'escape'=>false), null,false); ?>			<?php echo $this->Html->link($this->Html->image('lapis.gif', array('alt'=> __('Editar', true), 'border'=> '0', 'title'=>'Editar')), array('action'=>'edit', $militarscursoscorrigido['Militarscursoscorrigido']['id']),array('escape'=>false, 'escape'=>false), null,false); ?>			<?php  echo $this->Html->link($this->Html->image('lixo.gif', array('alt'=> __('Excluir', true), 'border'=> '0', 'title'=>'Excluir')), array(), array('onmousedown'=>"dialogo('Deseja realmente excluir o registro #".$militarscursoscorrigido['Militarscursoscorrigido']['id']." ?' ,'".$this->webroot.$this->params['controller'].'/delete/'.$militarscursoscorrigido['Militarscursoscorrigido']['id']."');",'onclick'=>"this.href='#';return false;",'escape'=>false, 'escape'=>false), null,false);?>		</td>
	</tr>
<?php endforeach; ?>
</table>
</div>
