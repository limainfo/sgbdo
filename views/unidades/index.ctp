...
?>
	...
	<table cellpadding="0" cellspacing="0">
                <tr><td colspan="6">
<h1><?php __('Unidades');?>	&nbsp;<?php echo $this->Html->link($this->Html->image('broffice.png', array('alt'=> __('BROffice', true), 'border'=> '0', 'title'=>'Dados em planilha BROffice', 'onmouseover'=>"\$('busca').action='".$this->webroot."unidades/indexExcel/';", 'onclick'=>'$("busca").submit();' )), '#', array('id'=>'broffice','escape'=>false), null,false); ?>	
...
<?php
		...
		echo '</select>&nbsp;&nbsp;&nbsp;<img border="0" onclick="ShowContent(\'filtro\');"  title="Filtrar Dados" alt="Filtro" src="'.$this->webroot.'img/filtro.gif"  onmouseover="$(\'busca\').action=\''.$this->webroot.'unidades/index/\';"/></div></div>'; ?>                
                </td></tr>
            
	<tr>
			<th><?php echo $this->Paginator->sort('cidade_id');?></th>
			<th><?php echo $this->Paginator->sort('nm_unidade');?></th>
			<th><?php echo $this->Paginator->sort('sigla_unidade');?></th>
			<th><?php echo $this->Paginator->sort('nm_cmt_unidade');?></th>
			<th><?php echo $this->Paginator->sort('tel_unidade');?></th>
	...
	<tr<?php echo $class;?>>
		...
		<td><?php echo $unidade['Unidade']['nm_unidade']; ?>&nbsp;</td>
		<td><?php echo $unidade['Unidade']['sigla_unidade']; ?>&nbsp;</td>
		<td><?php echo $unidade['Unidade']['nm_cmt_unidade']; ?>&nbsp;</td>
		<td><?php echo $unidade['Unidade']['tel_unidade']; ?>&nbsp;</td>
		<td class="actions">

		<?php echo $this->Html->link($this->Html->image('lupa.gif', array('alt'=> __('Exibir', true), 'border'=> '0', 'title'=>'Visualizar')), array('action'=>'view', $unidade['Unidade']['id']),array('escape'=>false, 'escape'=>false), null,false); ?>

		<?php echo $this->Html->link($this->Html->image('lapis.gif', array('alt'=> __('Editar', true), 'border'=> '0', 'title'=>'Editar')), array('action'=>'edit', $unidade['Unidade']['id']),array('escape'=>false, 'escape'=>false), null,false); ?>
