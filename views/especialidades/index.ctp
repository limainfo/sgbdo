...
<div class="especialidades index">
	<h1><?php __('Especialidades');?>	&nbsp;<?php echo $this->Html->link($this->Html->image('broffice.png', array('alt'=> __('BROffice', true), 'border'=> '0', 'title'=>'Dados em planilha BROffice', 'onmouseover'=>"\$('busca').action='".$this->webroot."especialidades/indexExcel/';", 'onclick'=>'$("busca").submit();' )), '#', array('id'=>'broffice','escape'=>false), null,false); ?>	
	...
	<?php echo $form->create('formFind', array('url' => 'index','type'=>'file','action' => 'index','controller' => 'especialidades','id'=>'busca','onsubmit'=>'sql();')); ?>	
	<h3>
	<?php
...
<?php
		...
		echo '</select>&nbsp;&nbsp;&nbsp;<img border="0" onclick="ShowContent(\'filtro\');"  title="Filtrar Dados" alt="Filtro" src="'.$this->webroot.'img/filtro.gif"  onmouseover="$(\'busca\').action=\''.$this->webroot.'especialidades/index/\';"/></div>'; ?>
...
?>
	...
	<tr>
			<th><?php echo $this->Paginator->sort('quadro_id');?></th>
			<th><?php echo $this->Paginator->sort('nm_especialidade');?></th>
			<th><?php echo $this->Paginator->sort('desc_especialidade');?></th>
			<th><?php echo $this->Paginator->sort('numeracao');?></th>
			<th><?php echo $this->Paginator->sort('equivalente_drhu');?></th>
	...
	<tr<?php echo $class;?>>
		...
		<td><?php echo $especialidade['Especialidade']['nm_especialidade']; ?>&nbsp;</td>
		<td><?php echo $especialidade['Especialidade']['desc_especialidade']; ?>&nbsp;</td>
		<td><?php echo $especialidade['Especialidade']['numeracao']; ?>&nbsp;</td>
		<td><?php echo $especialidade['Especialidade']['equivalente_drhu']; ?>&nbsp;</td>
		<td class="actions">

		<?php echo $this->Html->link($this->Html->image('lupa.gif', array('alt'=> __('Exibir', true), 'border'=> '0', 'title'=>'Visualizar')), array('action'=>'view', $especialidade['Especialidade']['id']),array('escape'=>false, 'escape'=>false), null,false); ?>

		<?php echo $this->Html->link($this->Html->image('lapis.gif', array('alt'=> __('Editar', true), 'border'=> '0', 'title'=>'Editar')), array('action'=>'edit', $especialidade['Especialidade']['id']),array('escape'=>false, 'escape'=>false), null,false); ?>
