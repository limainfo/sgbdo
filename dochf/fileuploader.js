...
qq.FileUploader = function(o){
    ...
    this._element.innerHTML = this._options.template.replace('{subLabel}', this._options.subLabel);        
...
qq.extend(qq.FileUploader.prototype, {
    ...
    _addToList: function(id, fileName){
        ...
        qq.attach(this._find(item, 'deleteItem'), 'click', function(){
            // This all works fine but if uploads two files with the same name we cannot delete the file
            // because server side script check the file_existance and adds a random number at the end of file name
            // therefore we cannot define which file it is and delete it.
...
if('JotForm' in window && 'initMultipleUploads' in JotForm){
