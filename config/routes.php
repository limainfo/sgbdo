...
//	Router::connect('/admin',array('controller'=>'events','prefix'=true>'admin','action'=>'index'));
//	Router::connect('/users/login',array('controller'=>'users','prefix'=>'admin','action'=>'login'));
...
//	Router::connect('/submit',array('controller'=>'users','action'=>'submit'));
	Router::connect('/', array('controller' => 'usuarios', 'action' => 'logout'));
/**
