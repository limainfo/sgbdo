<<?php
	...
	*/
	...
	class BARCODES
	{
		...
		function BARCODES($encoding="EAN-13")
		{
		    ...
		    //$this->_font= str_replace("/vendors/barcode/barcode.php","/webroot/fonts/arialbd.ttf",$_SERVER["SCRIPT_FILENAME"]);
		    $this->_font= 'fonts/arialbd.ttf';
